...
DATA.ENEMIES = {
  ...
  frostwolf:{ name:'フロストウルフ',  hp:40,  dmg:14, speed:23,   r:13, tier:2, env:'land', move:'chase', coin:5, sprite:'en_frostwolf',drops:[{m:'crystal',c:.4},{m:'hide',c:.3},{m:'iceshard',c:.35}] },
  ...
  mummy:    { name:'マミー',          hp:95,  dmg:19, speed:11,   r:15, tier:2, env:'land', move:'chase', coin:7, sprite:'en_mummy',   drops:[{m:'bone',c:.5},{m:'hide',c:.3},{m:'soulshard',c:.35}] },
  ...
  shade:    { name:'シェイド',        hp:70,  dmg:16, speed:28,   r:12, tier:2, env:'both', move:'chase', coin:6, sprite:'en_shade',   drops:[{m:'magic',c:.4},{m:'soulshard',c:.35}] },
