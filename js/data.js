...
DATA.META = {
  ...
  // --- 第1環 ---
  g_dragon_fang: { st:'b_dragon', fac:'war',  name:'竜牙の刃',  desc:'ボスへのダメージ +10%', max:15, cost:gcost(1800,1.45), effMul:{bossDmg:.10} },
  ...
  g_dusk_poem:   { st:'b_dusk', fac:'lore', name:'詩人の囁き', desc:'仲間になる確率 +0.5%', max:10, cost:gcost(2400,1.5), effAdd:{recruit:.005} },
  ...
  g_green_rest:  { st:'b_green', fac:'life', name:'森の寝床',  desc:'HP自動回復 +1/秒', max:10, cost:gcost(2600,1.5), effAdd:{regen:1} },
  ...
  g_white_snipe: { st:'b_white', fac:'war',  name:'灯火の狙撃', desc:'攻撃射程 +4%', max:10, cost:gcost(2800,1.5), effMul:{range:.04} },
  g_white_shell: { st:'b_white', fac:'life', name:'白亜の盾',  desc:'被ダメージ -1.4%', max:10, cost:gcost(3200,1.5), effAdd:{armor:.014} },
  g_white_gold:  { st:'b_white', fac:'lore', name:'白亜の商才', desc:'コイン獲得量 +15%', max:15, cost:gcost(3000,1.5) },
  ...
  g_black_skin:  { st:'b_black', fac:'life', name:'黒曜の皮膚', desc:'最大HP +28', max:15, cost:gcost(3800,1.5), effAdd:{maxHp:28} },
  g_black_pact:  { st:'b_black', fac:'lore', name:'契約の対価', desc:'コイン獲得量 +8%', max:15, cost:gcost(4200,1.55), effMul:{coinMul:.08} },
  ...
  g_ember_warm:  { st:'b_ember', fac:'life', name:'残り火の温もり', desc:'最大HP +22', max:15, cost:gcost(1500,1.45), effAdd:{maxHp:22} },
  g_ember_trade: { st:'b_ember', fac:'lore', name:'火の子の商い', desc:'コイン獲得量 +6%', max:15, cost:gcost(1700,1.5), effMul:{coinMul:.06} },
  ...
  g_forge_helm:  { st:'b_forge', fac:'life', name:'神鉄の兜',  desc:'最大HP +36', max:15, cost:gcost(7500,1.45), effAdd:{maxHp:36} },
  g_forge_arms:  { st:'b_forge', fac:'lore', name:'神鉄の武具(仲間用)', desc:'仲間の攻撃力 +7%', max:15, cost:gcost(8500,1.45), effMul:{allyAtk:.07} },
  ...
  g_moon_luck:   { st:'b_moon',  fac:'lore', name:'月の吉兆',  desc:'素材が2個落ちる確率 +5%', max:10, cost:gcost(9500,1.5), effAdd:{luck2:.05} },
  ...
  g_storm_ward:  { st:'b_storm', fac:'life', name:'避雷の護符', desc:'被ダメージ -2%', max:10, cost:gcost(9000,1.5), effAdd:{armor:.02} },
  g_storm_wind:  { st:'b_storm', fac:'lore', name:'風の運び手', desc:'移動速度 +3%', max:10, cost:gcost(8800,1.5), effMul:{speed:.03} },
  ...
  g_grave_gift:  { st:'b_grave', fac:'lore', name:'死者の貢物', desc:'コイン獲得量 +10%', max:15, cost:gcost(8600,1.5), effMul:{coinMul:.10} },
  ...
  g_sun_life:    { st:'b_sun',   fac:'life', name:'太陽の生命', desc:'HP自動回復 +2.5/秒', max:15, cost:gcost(36000,1.5), effAdd:{regen:2.5} },
  ...
  g_void_null:   { st:'b_void',  fac:'life', name:'虚無の帳',   desc:'リーパーからの被ダメージ -2% / リーパーへのダメージ +5%', max:15, cost:gcost(45000,1.5) },
  ...
  m_ashura:    { st:'altar', name:'修羅',     desc:'会心率 +1.5%',      max:10, cost:gcost(5000,1.45), unlockAch:'ach_kill2' },
  ...
  m_preserve:  { st:'lab',   name:'保存術',   desc:'開始時に基本素材を+1ずつ所持',   max:5,  cost:gcost(1200,1.6),  unlockAch:'ach_mats1' },
  ...
  m_stash:     { st:'lab',   name:'保管庫',   desc:'周回終了時、貴重な素材から順に Lv×4個 を次の周回へ持ち越す', max:8, cost:gcost(800,1.6) },
  // --- 最果て ---
  ...
  g_end_relic:   { st:'b_end',   fac:'lore', name:'彼方の遺物', desc:'素材ドロップ量 +7%', max:15, cost:gcost(130000,1.55), effMul:{dropMul:.07} },
