...
DATA.SIDEQUESTS = {
  ...
  main: [
    ...
    { id:'sq_yone', npc:'npc_girl', npcName:'巡礼者ヨネ', type:'visit', visit:{ x:-3800, y:-5600, label:'荒野の墓標' },
      ...
      ,'…だがな、解せんことがある。先の御仁もお前さんも、死んで還る。ワシの部下たちは、誰ひとり還らなんだ。……何が違うんじゃろうな。','…ひとつだけ。泉の底のゲートは、私たちが沈めたものではありません。誰が、いつ沈めたのか。記録が一枚も残っていないのです。','…そういやよ、この炉の火。誰が最初に入れたか知ってるか?俺の師匠も、そのまた師匠も知らねえ。火は最初から燃えてたんだとよ。おかしな話だろ。','…竜の骨は、いまも生きた声で鳴く。死んだ者が還らぬこの世で、骨だけがなぜ覚えておるのか。……問うても、骨は答えんわい。','…ひとつ、詩にできない話がある。この国の夕暮れは千年動いていない。夜も朝も来ないんだ。理由を知る者は、誰もいない。','…星図に一つだけ、この空には無い星が記されています。先代から写し継がれた図です。その星を見た者は、誰もいません。','…森は覚えておるよ。ずっと昔、この森を歩いた「還る魂」のことをな。お前さんで二人目じゃと、木々が言うておる。','…この灯りな、油を差した覚えがねえのに消えんのじゃ。ワシの代でも、親父の代でもな。灯台守の仕事は、実は掃除だけよ。','…静けさの底で、時おりこう聞こえる。「まだ足りぬ」と。誰の声かは、まだ分からぬ。修行が足りぬのだ。','…湯には言い伝えがあってな。「湯に浸かった魂は還りやすい」と。迷信だと思ってたが…あんたを見て、少し考えを変えたよ。','…毎年ひとり、峠を越えて北へ行ったきり戻らない客がいるんだよ。宿帳に名前だけが残ってね。もう三十年、ずっとさ。','…この森の薬草はな、どれも「還り」に効くと伝わっとる。何から還るのか、書いた者はもうおらんがの。','…霧の切れ目に、島がもう一つ見えることがある。どの地図にも無い島じゃ。近づこうとすると、霧が戻る。','へっへ…骨の相場でな、近ごろ妙なんだ。西の果てから流れてくる骨が、どれも同じ日に死んどる。同じ日にだぞ?','…ねえ。おばあちゃんの火ってさ、おばあちゃんが生まれる前からあったんだって。じゃあ、誰の火なの?','…氷の奥に、人がひとり閉じ込められています。解かしても、翌朝にはまた凍っているのです。……顔は、見ない方がよいでしょう。','…師匠は溶岩の底で「眠っている」。死んだとは誰も言わねえ。迎えに行った奴も、まだ誰も戻ってねえけどな。','…この月は欠けぬ。社が建ってから一度もな。欠けぬものを月と呼んでよいものか。……禁書には、そう書いてあるのじゃ。','…だがな、運ばれてくる亡骸に、まだ息をしている者が混じることがある。そういう奴は、翌朝には消えているのさ。','…日輪の鏡は、時おりあなたの後ろを映します。そこには誰も立っていないのに。太陽は、すべてを見ていますから。','……ひとつ教えておこう。全ての魂は門を通る。お前は通らずに戻ってきた。それが何を意味するかは、まだ言えぬ。','…沈む前、この都は「還らぬ者たちの街」と呼ばれていました。なぜそう呼ばれたのか、歌にすら残っていません。'] },
