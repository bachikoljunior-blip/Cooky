...
DATA.SIDEQUESTS = {
  ...
  b_north: [
    ...
    { id:'sq_toto', npc:'npc_mapper', npcName:'地図職人トト', type:'visit', visit:{ x:10200, y:5000, label:'東の丘の測量点' },
      ...
      done:['おお、戻ったか!…なに?丘の向こうに古い遺跡と街があった?','それは「東の遺跡」…学術都市じゃよ。地図に描いておこう。','ついでじゃ。測量の途中、北の海岸に港町が見えたでな…そっちも描いておくよ。'],
...
DATA.QUESTS2 = {
  ...
  b_west: { npcName:'鍛冶師ドバン', offer:'デカい仕事が入ってな。材料を都合してくれりゃ分け前をやるぜ。',
    ...
    done:['っしゃあ!間に合った!ほらよ、分け前だ。','(報酬を受け取った!)','品は「西の港町」から船で王都に送るんだ。荷馬車が通う道の先…場所を地図に描いといてやる。','ついでにお前さん用の炉も火を入れといた。(この基地のパワーアップ施設が使えるようになった!)'],
