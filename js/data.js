...
DATA.SKILLS = {
  ...
  wildcall: {
    ...
    desc:'一定間隔で近くの敵1体を仲間に引き入れる。',
    cost:(lv)=>matCost(lv,{hide:5,wood:5},[{from:2,mat:'beastfang',qty:3}]),
    lvText:['再発動-15%','中位の魔物まで仲間化','再発動-20%','上位の魔物まで仲間化','再発動-25%'],
...
PASSIVE_DEFS.forEach(([id, name, effDesc, key, per, unit, ma, qa, mb, qb, cat], idx) => {
  ...
  DATA.SKILLS[id] = {
    ...
    lvText: Array.from({ length: 9 }, (_, i) => `${effDesc} ${unit}`),
...
DATA.CONTINENTS = [
  ...
  // 竜骨: 東の隣人。西の広い頭から北東へ弓なりに細る竜の背。
  // 背の中程に北のこぶ、頭の付け根から南東へ尾びれ(半島)が垂れる
  { id:'east', x:139500, y:-12200, seed:23, name:'竜骨の大陸', biome:'volcano', lobes:6, amp:0.15, r:66250,
    parts:[
      { dx:-58220, dy:20076, r:37140, sx:1.2,  sy:0.9,  rot:-0.2,  lobes:5, amp:0.15 },
      { dx:-4015, dy:-4015, r:33125, sx:1.25, sy:0.85, rot:-0.35, lobes:6, amp:0.15 },
      { dx:44167, dy:-26098, r:27102, sx:1.25, sy:0.8,  rot:-0.45, lobes:6, amp:0.16 },
      { dx:82310, dy:-46174, r:20076, sx:1.3,  sy:0.7,  rot:-0.5,  lobes:4, amp:0.17 },
      { dx:-10000, dy:-36000, r:13000, sx:1.1, sy:0.95, rot:-0.3, lobes:5, amp:0.17 },
      { dx:-36000, dy:50000, r:12500, sx:1.05, sy:1.0, rot:0.25, lobes:5, amp:0.18 },
  ...
  { id:'west', x:-95200, y:5000, seed:37, name:'黄昏の大陸', biome:'twilight', lobes:6, amp:0.16, r:49538,
    parts:[
      ...
      { dx:4587, dy:20182, r:29356, sx:1.2,  sy:0.85, rot:0.15, lobes:6, amp:0.15 },
      { dx:-36695, dy:11008, r:26604, sx:1.05, sy:0.95, rot:0.4,  lobes:7, amp:0.16 },
  ...
  { id:'north', x:-5400, y:-104000, seed:41, name:'星嵐の大陸', biome:'frost', lobes:6, amp:0.16, r:53706,
    parts:[
      ...
      { dx:926, dy:5556, r:22223, sx:0.95, sy:1.15, rot:0.05, lobes:6, amp:0.16 },
      { dx:13890, dy:-44446, r:27779, sx:1.05, sy:1.05, rot:0.2,  lobes:6, amp:0.15 },
  ...
  { id:'south', x:6600, y:75900, seed:53, name:'深緑の大陸', biome:'jungle', lobes:7, amp:0.15, r:47846,
    parts:[
      { dx:-7088, dy:-28353, r:23037, sx:1.15, sy:0.9,  rot:-0.1, lobes:6, amp:0.15 },
      { dx:-22151, dy:13290, r:29239, sx:1.15, sy:1.0,  rot:-0.3, lobes:7, amp:0.15 },
      { dx:-33669, dy:42529, r:23037, sx:1.05, sy:0.95, rot:-0.2, lobes:5, amp:0.16 },
      { dx:21265, dy:5316, r:15949, sx:1.2,  sy:0.8,  rot:0.2,  lobes:4, amp:0.17 },
    ] },
  ...
  { id:'r3_void', x:-214200, y:30100, seed:131, name:'虚無の大陸', biome:'void', lobes:8, amp:0.25, r:40401,
    parts:[
      { dx:-12120, dy:-13467, r:26934, sx:0.95, sy:1.15, rot:0.8, lobes:8, amp:0.22 },
      { dx:13467, dy:16160, r:24240, sx:1.05, sy:0.95, rot:0.6, lobes:7, amp:0.22 },
    ] },
  // 最果て: 牙のような板が寄り集まった禍々しい群島大陸
  { id:'r4_end', x:7700, y:-220100, seed:137, name:'最果ての大陸', biome:'end', lobes:9, amp:0.28, r:38949,
    parts:[
      { dx:-16878, dy:5193, r:25966, lobes:8, amp:0.22 },
      { dx:12983, dy:-12983, r:28563, lobes:9, amp:0.22 },
      { dx:19475, dy:15580, r:22071, lobes:7, amp:0.24 },
    ] },
  // --- 無人の小島(海路の景色。拠点はない) ---
  { id:'sk1', x:21700, y:-25900,  r:4500, seed:141, name:'岩礁の小島', biome:'grass',  lobes:4, amp:0.35 },
  { id:'sk2', x:-35200, y:41700,   r:5000, seed:143, name:'風待ちの小島', biome:'grass', lobes:5, amp:0.3 },
  { id:'sk3', x:150000, y:-61000,  r:5500, seed:149, name:'陽炎の小島', biome:'desert', lobes:4, amp:0.35 },
  { id:'sk4', x:-184100, y:20500,  r:5000, seed:151, name:'宵の小島',   biome:'twilight', lobes:4, amp:0.3 },
...
DATA.BASES = [
  ...
  { id:'b_spa',   name:'竜の湯',     x:107000, y:42000, cont:'east', kind:'湯治の村', spr:'base_spa', danger:5 },
  ...
  // 最果て
  { id:'b_end',   name:'最果ての碑', x:-5300, y:-217500, cont:'r4_end', kind:'最果ての城', spr:'base_castle', danger:12 },
];
...
DATA.META = {
  ...
  altar_crit:   { st:'altar', name:'会心の心得',   desc:'会心率 +2%(会心は2倍ダメージ)', max:25, cost:gcost(50,1.42) },
  ...
  g_north_fear:  { st:'b_north', fac:'war',  name:'威圧の号令', desc:'スキル「威圧のオーラ」の効き目 +4%', max:15, cost:gcost(220,1.45) },
  ...
  g_east_cdr:    { st:'b_east', fac:'lore', name:'古代の叡智', desc:'武器の攻撃間隔 -1.5%', max:20, cost:gcost(180,1.42) },
  ...
  // --- 第1環 ---
  g_dragon_fang: { st:'b_dragon', fac:'war',  name:'竜牙の刃',  desc:'ボスへのダメージ +10%', max:15, cost:gcost(920,1.45), effMul:{bossDmg:.10} },
  g_dragon_res:  { st:'b_dragon', fac:'life', name:'竜鱗の守り', desc:'リーパーからの被ダメージ -6%(最大90%)', max:15, cost:gcost(1000,1.5) },
  g_dragon_craft:{ st:'b_dragon', fac:'lore', name:'竜骨細工',  desc:'素材ドロップ量 +4%', max:15, cost:gcost(980,1.45), effMul:{dropMul:.04} },
  g_dragon_kokoroe:{ st:'b_dragon', fac:'lore', name:'竜の教練', desc:'全ての心得の効果 +4%', max:15, cost:gcost(1050,1.45) },
  g_dragon_sk:   { st:'b_dragon', fac:'war', name:'【解放】竜鱗の陣', desc:'スキル「竜鱗の陣」を習得可能に', max:1, cost:gcost(1800,1) },
  g_dusk_slay:   { st:'b_dusk', fac:'war',  name:'終焉狩り',   desc:'リーパーへのダメージ +15%', max:20, cost:gcost(980,1.5) },
  g_dusk_veil:   { st:'b_dusk', fac:'life', name:'黄昏の帳',   desc:'回避率 +0.8%', max:10, cost:gcost(1100,1.5), effAdd:{dodge:.008} },
  g_dusk_poem:   { st:'b_dusk', fac:'lore', name:'詩人の囁き', desc:'仲間になる確率 +0.5%', max:10, cost:gcost(1200,1.5), effAdd:{recruit:.005} },
  g_dusk_sk:     { st:'b_dusk', fac:'lore', name:'【解放】黄昏の帳', desc:'スキル「黄昏の帳」を習得可能に(素材「宵の紗」も出現)', max:1, cost:gcost(1700,1) },
  g_star_meteor: { st:'b_star', fac:'war',  name:'流星の火',   desc:'会心率 +1.5%', max:10, cost:gcost(1500,1.5), effAdd:{crit:.015} },
  g_star_time:   { st:'b_star', fac:'life', name:'星読みの加護', desc:'強い色違いの敵が出にくくなる(-3%。最大-45%)', max:15, cost:gcost(1650,1.55) },
  ...
  g_green_sk:    { st:'b_green', fac:'war', name:'【解放】野生の呼び声', desc:'スキル「野生の呼び声」を習得可能に(素材「獣牙」も出現)', max:1, cost:gcost(880,1) },
  g_white_snipe: { st:'b_white', fac:'war',  name:'灯火の狙撃', desc:'攻撃射程 +4%', max:10, cost:gcost(2250,1.5), effMul:{range:.04} },
  g_white_shell: { st:'b_white', fac:'life', name:'白亜の盾',  desc:'被ダメージ -1.4%', max:10, cost:gcost(2600,1.5), effAdd:{armor:.014} },
  ...
  g_black_sk:    { st:'b_black', fac:'lore', name:'【解放】対価の契約', desc:'スキル「対価の契約」を習得可能に(素材「黒曜のかけら」も出現)', max:1, cost:gcost(2500,1) },
  // --- 中間の小島 ---
  ...
  g_mist_gather: { st:'b_mist',  fac:'lore', name:'霧の収集家', desc:'アイテム回収範囲 +8%', max:10, cost:gcost(1300,1.45), effMul:{magnet:.08} },
  g_mist_confuse:{ st:'b_mist',  fac:'lore', name:'幻惑の霧',   desc:'スキル「混沌の瘴気」の効き目 +4%', max:15, cost:gcost(1500,1.45) },
  g_mist_sk:     { st:'b_mist', fac:'war',  name:'【解放】霧渡り', desc:'スキル「霧渡り」を習得可能に', max:1, cost:gcost(2000,1) },
  g_bones_spike: { st:'b_bones', fac:'war',  name:'骨の棘',    desc:'接触してきた敵に反撃ダメージ +12', max:15, cost:gcost(1500,1.45), effAdd:{thorns:12} },
  g_bones_broth: { st:'b_bones', fac:'life', name:'骨髄の薬',  desc:'HP自動回復 +1.4/秒', max:10, cost:gcost(1700,1.5), effAdd:{regen:1.4} },
  ...
  g_ember_burn:  { st:'b_ember', fac:'war',  name:'燃えさしの祝福', desc:'攻撃が4%の確率で敵を炎上させる', max:10, cost:gcost(1500,1.5) },
  g_ember_warm:  { st:'b_ember', fac:'life', name:'残り火の温もり', desc:'最大HP +22', max:15, cost:gcost(1400,1.45), effAdd:{maxHp:22} },
  g_ember_trade: { st:'b_ember', fac:'lore', name:'火の子の商い', desc:'コイン獲得量 +6%', max:15, cost:gcost(1600,1.5), effMul:{coinMul:.06} },
  g_ember_sk:    { st:'b_ember', fac:'war',  name:'【解放】火の粉', desc:'スキル「火の粉」を習得できるようになる', max:1, cost:gcost(2300,1) },
  ...
  g_moss_salve:  { st:'b_moss', fac:'life', name:'薬師の膏薬',   desc:'HP自動回復 +1.2/秒(旅の常備薬)', max:10, cost:gcost(1400,1.45), effAdd:{regen:1.2} },
  g_moss_ward:   { st:'b_moss', fac:'life', name:'苔の護り',     desc:'被ダメージ -1.2%', max:10, cost:gcost(1500,1.5), effAdd:{armor:.012} },
  g_moss_needle: { st:'b_moss', fac:'war',  name:'急所の心得',   desc:'会心率 +1.5%', max:10, cost:gcost(1600,1.5), effAdd:{crit:.015} },
  g_moss_herb:   { st:'b_moss', fac:'lore', name:'薬草の目利き', desc:'素材ドロップ量 +6.5%', max:10, cost:gcost(1500,1.5), effMul:{dropMul:.065} },
  g_frost_slow:  { st:'b_frost', fac:'war',  name:'霜の吐息',   desc:'攻撃が3%の確率で敵を凍らせる(足が遅くなる)', max:10, cost:gcost(1600,1.5) },
  g_frost_armor: { st:'b_frost', fac:'life', name:'氷の鎧',    desc:'被ダメージ -1.6%', max:10, cost:gcost(1700,1.5), effAdd:{armor:.016} },
  g_frost_store: { st:'b_frost', fac:'lore', name:'氷室の保存', desc:'素材ドロップ量 +5%', max:15, cost:gcost(1500,1.45), effMul:{dropMul:.05} },
  ...
  g_forge_sk:    { st:'b_forge', fac:'life', name:'【解放】神鉄の壁', desc:'スキル「神鉄の壁」を習得可能に', max:1, cost:gcost(6300,1) },
  g_moon_blade:  { st:'b_moon',  fac:'war',  name:'月光の刃',  desc:'会心率 +2%', max:10, cost:gcost(5250,1.5), effAdd:{crit:.02} },
  g_moon_shadow: { st:'b_moon',  fac:'life', name:'影歩き',     desc:'被弾後の無敵時間 +0.06秒', max:10, cost:gcost(5600,1.5) },
  g_moon_luck:   { st:'b_moon',  fac:'lore', name:'月の吉兆',  desc:'素材が2個落ちる確率 +5%', max:10, cost:gcost(5900,1.5), effAdd:{luck2:.05} },
  g_moon_sk:     { st:'b_moon', fac:'war',  name:'【解放】月光の疾走', desc:'スキル「月光の疾走」を習得可能に', max:1, cost:gcost(5600,1) },
  g_storm_bolt:  { st:'b_storm', fac:'war',  name:'嵐の加護',   desc:'9秒ごとに自動で落雷が敵を撃つ(威力+20/Lv)', max:15, cost:gcost(8000,1.45) },
  g_storm_ward:  { st:'b_storm', fac:'life', name:'避雷の護符', desc:'被ダメージ -2%', max:10, cost:gcost(8450,1.5), effAdd:{armor:.02} },
  g_storm_wind:  { st:'b_storm', fac:'lore', name:'風の運び手', desc:'移動速度 +3%', max:10, cost:gcost(8250,1.5), effMul:{speed:.03} },
  g_storm_boots: { st:'b_storm', fac:'lore', name:'追い風',     desc:'スキル「ヘルメスの靴」の効き目 +3%', max:10, cost:gcost(8450,1.5) },
  g_storm_sk:    { st:'b_storm', fac:'war', name:'【解放】雷雲の呼び声', desc:'スキル「雷雲の呼び声」を習得可能に', max:1, cost:gcost(8450,1) },
  g_grave_blast: { st:'b_grave', fac:'war',  name:'弔いの爆炎', desc:'仲間が倒れた時に爆発(威力+30/Lv)', max:15, cost:gcost(3450,1.45) },
  g_grave_pray:  { st:'b_grave', fac:'life', name:'墓守の祈り', desc:'仲間のHP +5%', max:15, cost:gcost(3550,1.45), effMul:{allyHp:.05} },
  g_grave_gift:  { st:'b_grave', fac:'lore', name:'死者の貢物', desc:'コイン獲得量 +10%', max:15, cost:gcost(3700,1.5), effMul:{coinMul:.10} },
  ...
  g_void_edge:   { st:'b_void',  fac:'war',  name:'虚無の刃',  desc:'リーパーへのダメージ +6%', max:15, cost:gcost(12000,1.5), effMul:{reaperDmg:.06} },
  g_void_null:   { st:'b_void',  fac:'life', name:'虚無の帳',   desc:'リーパーからの被ダメージ -2% / リーパーへのダメージ +5%', max:15, cost:gcost(13000,1.5) },
  ...
  m_deathlearn:{ st:'altar', name:'死中の活', desc:'力尽きた時の持ち帰りコイン +10%', max:10, cost:gcost(400,1.45), unlockAch:'ach_die10' },
  m_bond2:     { st:'camp',  name:'友の絆',   desc:'仲間HP +6%',                max:10, cost:gcost(320,1.4),   unlockAch:'ach_recruit1' },
  m_legion:    { st:'camp',  name:'軍団旗',   desc:'仲間攻撃力 +6%',            max:10, cost:gcost(950,1.45), unlockAch:'ach_allies20' },
  m_bosslore:  { st:'lib',   name:'弱点研究', desc:'ボスへのダメージ +5%',      max:10, cost:gcost(550,1.45), unlockAch:'ach_boss1' },
  m_satori:    { st:'lib',   name:'悟り',     desc:'武器の攻撃間隔 -1%',        max:10, cost:gcost(550,1.5),  unlockAch:'ach_skills' },
  m_endbook:   { st:'lib',   name:'終焉の書', desc:'リーパー被ダメ -2%',        max:10, cost:gcost(2250,1.5),  unlockAch:'ach_time2' },
  m_reaplore:  { st:'lab',   name:'終焉の知識', desc:'リーパーへのダメージ +4%', max:10, cost:gcost(1300,1.45), unlockAch:'ach_reaper1' },
  m_cartography:{ st:'lab',  name:'地図学',   desc:'探索でマップに記録される範囲が広がる', max:4, cost:gcost(250,1.8), unlockAch:'ach_dist1' },
  m_preserve:  { st:'lab',   name:'保存術',   desc:'開始時に基本素材を+1ずつ所持',   max:5,  cost:gcost(250,1.6),  unlockAch:'ach_mats1' },
  m_salvage:   { st:'lab',   name:'解体術',   desc:'オブジェクトが追加素材を落とす確率 +8%', max:10, cost:gcost(250,1.45), unlockAch:'ach_obj1' },
  m_shipwright:{ st:'lab',   name:'造船学',   desc:'船の速度 +12%',             max:10, cost:gcost(1200,1.45), unlockAch:'ach_ports' },
  ...
  // --- 沈み都(海底都市) ---
  g_sea_tide:    { st:'b_sea', fac:'war',  name:'潮流の型',     desc:'会心率 +2.2%',  max:10, cost:gcost(2800,1.45), effAdd:{crit:.022} },
  g_sea_breath:  { st:'b_sea', fac:'life', name:'潮の息継ぎ',   desc:'HP自動回復 +1.5/秒(長い航海の体力)', max:10, cost:gcost(2600,1.45), effAdd:{regen:1.5} },
  g_sea_pearl:   { st:'b_sea', fac:'lore', name:'真珠の目利き', desc:'コイン獲得 +11%',     max:15, cost:gcost(2400,1.45), effMul:{coinMul:.11} },
  g_sea_sk:      { st:'b_sea', fac:'war',  name:'【解放】潮汐の恵み', desc:'スキル「潮汐の恵み」を習得可能に', max:1, cost:gcost(2600,1) },
};

// ---------------- 価格の天井(docs/PACING.md「腐らせない価格の基準」) ----------------
// 伸び率(×1.4〜1.55/Lv)は最大Lvが多い項目で二重に効き、上のほうのレベルが
// 「効果はあるのに一生買えない=ゲーム中で一度も働かない」値段になっていた
// (実測: 終焉超越の最終Lv 9.3億 / 終盤の1周回の稼ぎは実測50万)。
// 最終Lvの価格が「終盤の1周回の稼ぎ×10」を超える項目だけ、伸び率を下げて天井に収める。
// 初期Lvの価格は動かさないので、序盤〜中盤の買えるレベル数(4〜5/周回)は変わらない。
const PRICE_CEIL = 5000000;
for (const id in DATA.META) {
  const d = DATA.META[id];
  if (d.max < 2) continue;
  const first = d.cost(0);
  if (d.cost(d.max - 1) <= PRICE_CEIL) continue;
  const g = Math.pow(PRICE_CEIL / first, 1 / (d.max - 1));
  d.cost = (lv) => Math.floor(first * Math.pow(g, lv));
}
...
DATA.BASE_FACS = {
  ...
  lore: { name:'秘宝の蔵', sprite:'st_lore', short:'蔵',   desc:'経済・仲間などの特別強化' },
};

// ---------------- 基地マップの実景(HUB_THEME) ----------------
// ストーリーに出てくるもの(泉・御神木・大炉・湯壺・歌碑・灯台…)を、その基地のマップに
// 実物として置く。props=飾り(種類kindごとの描画はhub.js)。
// 街の当たり判定は town.js の建物・壁・水が持つので、ここは飾りだけを置く。
// 座標はマップ中央基準。建物や壁と重なる位置の飾りは、その街では出さない(hub.js が省く)。
DATA.HUB_THEME = {
  // 魂の広場: 先人オウが築いた祭壇を中心に、石柱の環・魂のかがり火・魂の泉。
  // 「広場に祭壇を築いた」という物語(手記二頁目・オウの告白)が実景になっている
  main: { floor:'#131a2b',
    props:[ { k:'pillar', x:-150, y:-278, s:72 }, { k:'pillar', x:150, y:-278, s:72 },
            { k:'pillar', x:-268, y:-248, s:52, broken:1 }, { k:'pillar', x:268, y:-248, s:52, broken:1 },
            { k:'fire', x:-92, y:-188, s:34 }, { k:'fire', x:92, y:-188, s:34 },
            { k:'pool', x:-450, y:130, rx:115, ry:65, c:'#2b6fb0' },
            { k:'stele', x:-565, y:-215, s:42, c:'#76e3ea' },
            { k:'sprite', spr:'ob_crate', x:585, y:70, s:32 }, { k:'sprite', spr:'ob_crate', x:627, y:92, s:24 },
            { k:'crystal', x:-740, y:-290, s:40, c:'#76e3ea' }, { k:'crystal', x:740, y:-290, s:40, c:'#76e3ea' } ] },
  b_north: { floor:'#1a2030',
    props:[ { k:'wall', x:-500, y:-300, w:220 }, { k:'wall', x:500, y:-300, w:220 }, { k:'tower', x:-560, y:-250, s:110, c:'#8b949e' },
            { k:'sprite', spr:'ob_crate', x:520, y:60, s:34 }, { k:'sprite', spr:'ob_crate', x:560, y:90, s:26 } ] },
  b_east: { floor:'#1b1f2e',
    props:[ { k:'pillar', x:-540, y:-260, s:120 }, { k:'pillar', x:540, y:-260, s:120 }, { k:'pillar', x:-560, y:120, s:80, broken:1 },
            { k:'pillar', x:560, y:110, s:95, broken:1 }, { k:'stele', x:0, y:-210, s:56, c:'#76e3ea' } ] },
  b_south: { floor:'#16232b',
    props:[ { k:'pool', x:-440, y:40, rx:180, ry:110, c:'#2b7fb0' }, { k:'sprite', spr:'ob_tree', x:560, y:-240, s:80 },
            { k:'stele', x:-440, y:-120, s:40, c:'#a5d8ff' } ] },
  b_west: { floor:'#241d1a',
    props:[ { k:'furnace', x:-560, y:-250, s:120 }, { k:'anvil', x:-450, y:-160, s:40 },
            { k:'sprite', spr:'ob_crate', x:530, y:80, s:32 } ] },
  b_dragon: { floor:'#231d18',
    props:[ { k:'bonearch', x:0, y:-250, s:220 }, { k:'sprite', spr:'ob_rock', x:-560, y:60, s:56 },
            { k:'sprite', spr:'ob_rock', x:600, y:-130, s:48 } ] },
  b_spa: { floor:'#20242a',
    props:[ { k:'pool', x:-460, y:60, rx:150, ry:95, c:'#7fd1c9', steam:1 }, { k:'pool', x:480, y:-160, rx:110, ry:75, c:'#7fd1c9', steam:1 },
            { k:'sprite', spr:'ob_rock', x:-300, y:-40, s:40 } ] },
  b_mist: { floor:'#1e2420', mist:1,
    props:[ { k:'lens', x:520, y:-260, s:90 }, { k:'sprite', spr:'ob_rock', x:-540, y:-140, s:44 } ] },
  b_white: { floor:'#20242c',
    props:[ { k:'tower', x:560, y:-270, s:170, c:'#e6edf3', light:1 }, { k:'sprite', spr:'ob_crate', x:-520, y:60, s:34 },
            { k:'sprite', spr:'ob_crate', x:-480, y:90, s:26 } ] },
  b_forge: { floor:'#26180f',
    props:[ { k:'furnace', x:-560, y:-260, s:150 }, { k:'furnace', x:560, y:-260, s:130 }, { k:'anvil', x:0, y:150, s:48 } ] },
  b_dusk: { floor:'#251f2b', fireflies:1,
    props:[ { k:'stele', x:-520, y:-240, s:64, c:'#f778ba' }, { k:'sprite', spr:'ob_tree', x:560, y:-250, s:78 },
            { k:'sprite', spr:'ob_tree', x:600, y:100, s:64 } ] },
  b_black: { floor:'#171b1f',
    props:[ { k:'shrine', x:0, y:-240, s:100, c:'#2dd4bf' }, { k:'crystal', x:-540, y:-140, s:56, c:'#484f58' },
            { k:'crystal', x:540, y:60, s:48, c:'#484f58' } ] },
  b_bones: { floor:'#26221a',
    props:[ { k:'graves', x:-540, y:-180, s:1.3, c:'#e6edf3' }, { k:'fire', x:0, y:60, s:40 },
            { k:'sprite', spr:'ob_house2', x:560, y:-250, s:74 } ] },
  b_moon: { floor:'#141a33',
    props:[ { k:'moon', x:0, y:-460, s:64 }, { k:'pillar', x:-520, y:-230, s:110 }, { k:'pillar', x:520, y:-230, s:110 } ] },
  b_green: { floor:'#15231a',
    props:[ { k:'bigtree', x:-150, y:-270, s:200 }, { k:'sprite', spr:'ob_tree', x:-580, y:60, s:70 },
            { k:'sprite', spr:'ob_tree', x:600, y:-120, s:76 }, { k:'herb', x:-500, y:150, s:1 } ] },
  b_moss: { floor:'#1a231d',
    props:[ { k:'herb', x:-500, y:-180, s:1.2 }, { k:'herb', x:480, y:100, s:1 }, { k:'pool', x:520, y:-220, rx:95, ry:65, c:'#3a7f6f' },
            { k:'bigtree', x:-580, y:-260, s:120, mossy:1 } ] },
  b_ember: { floor:'#261510', embers:1,
    props:[ { k:'fire', x:-520, y:-200, s:56 }, { k:'fire', x:520, y:-200, s:48 }, { k:'sprite', spr:'ob_rock', x:0, y:130, s:44 } ] },
  b_grave: { floor:'#1b1520',
    props:[ { k:'graves', x:-540, y:-200, s:1.4, c:'#c9d1d9' }, { k:'graves', x:520, y:200, s:1.1, c:'#c9d1d9' },
            { k:'stele', x:0, y:-230, s:70, c:'#c084fc' }, { k:'fire', x:-90, y:-160, s:22 }, { k:'fire', x:90, y:-160, s:22 } ] },
  b_star: { floor:'#131b33', stars:1,
    props:[ { k:'lens', x:-540, y:-260, s:110 }, { k:'crystal', x:540, y:-220, s:64, c:'#a5d8ff' },
            { k:'crystal', x:600, y:80, s:44, c:'#a5d8ff' } ] },
  b_inn: { floor:'#221d16',
    props:[ { k:'sprite', spr:'ob_house', x:-560, y:-250, s:96 }, { k:'sprite', spr:'ob_house2', x:560, y:-245, s:86 },
            { k:'fire', x:0, y:90, s:44 }, { k:'wall', x:520, y:150, w:180 }, { k:'sprite', spr:'ob_crate', x:-520, y:80, s:30 } ] },
  b_frost: { floor:'#1c2833',
    props:[ { k:'crystal', x:-540, y:-220, s:80, c:'#a5d8ff' }, { k:'crystal', x:540, y:-190, s:64, c:'#76e3ea' },
            { k:'pool', x:480, y:120, rx:120, ry:70, c:'#9fc8dd', frozen:1 } ] },
  b_storm: { floor:'#1d2422', storm:1,
    props:[ { k:'tower', x:400, y:-300, s:150, c:'#8b949e', rod:1 }, { k:'wall', x:-540, y:-220, w:170 }, { k:'wall', x:540, y:-220, w:170 } ] },
  b_sun: { floor:'#2b2010',
    props:[ { k:'mirror', x:-540, y:-250, s:80 }, { k:'mirror', x:540, y:-250, s:80 }, { k:'pillar', x:-580, y:100, s:90, gold:1 },
            { k:'pillar', x:580, y:90, s:90, gold:1 } ] },
  b_void: { floor:'#120f1c', voidmist:1,
    props:[ { k:'crystal', x:-520, y:-220, s:70, c:'#a78bfa' }, { k:'crystal', x:520, y:-200, s:56, c:'#6e40c9' },
            { k:'shrine', x:0, y:-250, s:80, c:'#a78bfa' } ] },
  b_sea: { floor:'#123240',
    props:[ { k:'pool', x:-510, y:40, rx:170, ry:115, c:'#1f6f9f', lagoon:1 }, { k:'sprite', spr:'ob_coral', x:520, y:60, s:50 },
            { k:'sprite', spr:'ob_coral', x:580, y:-140, s:42 }, { k:'sprite', spr:'ob_pearl', x:-510, y:40, s:36 } ] },
  b_end: { floor:'#1c1015',
    props:[ { k:'stele', x:170, y:-260, s:100, c:'#f85149' }, { k:'wall', x:-560, y:-240, w:200, ruined:1 },
            { k:'wall', x:560, y:-240, w:200, ruined:1 }, { k:'tower', x:560, y:-300, s:130, c:'#2d1418' } ] },
};
...
DATA.SIDEQUESTS = {
  ...
  main: [
    { id:'sq_toto2', npc:'npc_mapper', npcName:'地図職人トト', type:'delivery', need:{ mats:{ wood:12 } },
      after:'ワシの生涯最高の地図、役に立っとるか?お前さんが歩いた分だけ、地図はまだ良うなるでな。',
    ...
    { id:'sq_kalci', npc:'en_skel', npcName:'骸骨兵カルシ', type:'hunt', enemy:'shade', count:8,
      after:'カタカタ…(同胞たちは息災だ。我らの骨は、いつでもお前と共にある)',
    ...
    { id:'sq_yone', npc:'npc_girl', npcName:'巡礼者ヨネ', type:'visit', visit:{ x:-3800, y:-5600, label:'荒野の墓標' },
      ...
      intro:['あなたが…「死に戻り」の御方ですね。巡礼者のヨネと申します。','息子は北の砦の兵士でした。北の荒野で死に…そして、還りませんでした。','普通の魂は還らない。だからこそ人は、還るあなたを畏れ、あるいは崇めるのです。','荒野に息子の墓標があります。この祈り石を、供えてきていただけませんか。'],
    ...
    { id:'sq_hoshi', npc:'npc_miko', npcName:'星詠みの弟子ホシ', type:'delivery', need:{ mats:{ crystal:8 } },
      after:'写本はお役に立っていますか?知は使う者の心次第…あなたなら、きっと大丈夫ですね。',
      ...
      done:['写本ができました。「混沌の瘴気」の知識をあなたに。','(スキル「混沌の瘴気」が解放された)'],
      reward:{ coins:100, metaLv:{ lib_sk_confuse:1 }, story:'hoshi_book' } },
  ],
  b_north: [
    { id:'sq_hanna', npc:'npc_girl', npcName:'村娘ハンナ', type:'hunt', nearLoc:true, enemy:'slime', count:8,
    ...
    { id:'sq_toto', npc:'npc_mapper', npcName:'地図職人トト', type:'visit', visit:{ x:10400, y:5160, label:'東の丘の測量点' },   // 遺跡の街が画面に見える丘の上
      leaveStory:'toto_map',   // 依頼を果たすと魂の広場へ工房を移す
      requiresStory:'north_peace', lockedLine:'今は測量の計算中でな…村の手伝いでもしてきてくれ。',
      intro:['ワシは地図職人のトト。東の丘に測量点を打ったんじゃが、','護衛がおらんで回収に行けん。代わりに測量点を調べてきてくれ。','南東へまっすぐ…荒野と丘をいくつも越えた先じゃ。'],
      done:['おお、戻ったか!…なに?丘の向こうに古い遺跡と街があった?','それは「東の遺跡」…学術都市じゃよ。おおよその見当を地図に付けておこう。','ついでじゃ。測量の途中、北の海岸で回る灯りを見た。おそらく灯台…港町じゃろう。そちらも見当だけ描いておくよ。'],
      reward:{ coins:80, hintBase:'b_east', hintPort:'p_n', story:'toto_map' } },
  ],
  b_east: [
    { id:'sq_kilo', npc:'npc_boy', npcName:'見習い研究員キロ', type:'hunt', nearLoc:true, enemy:'goblin', count:10,
      intro:['ぼく、リナ先生の弟子なんだ。','ゴブリンが研究資料を持っていっちゃう!10体やっつけて!'],
      done:['資料が戻ってきた!ありがとう!','この天文資料…北西の空の下にある「星降りの祭壇」の記述だ。地図に写しておくね。'],
    ...
    { id:'sq_tetsu', npc:'npc_sailor', npcName:'行商のテツ', type:'visit', visit:{ x:-2150, y:12400, label:'南の泉のほとり' },   // 村が画面に見えるほとり
  ...
  b_south: [
    { id:'sq_tome', npc:'npc_girl', npcName:'巡礼のトメ婆', type:'escort', ehp:280, escortSpr:'npc_girl',
      ...
      done:['ありがとうねえ…何十年ぶりかの祈り場じゃったよ。','祈り場から北西の空に、煙が立っとったろう?あれは「西の炉」…鍛冶の街の炉の煙よ。','ばあの息子があそこで炭鉱夫をしとる。地図に描いてあげよう。訪ねてやってな。','あんたの旅路にも、ようけ祝福がありますように。'],
      reward:{ coins:90, hintBase:'b_west', story:'tome_walk' } },
    { id:'sq_mama', npc:'npc_girl', npcName:'宿屋の女将マーサ', type:'hunt', nearLoc:true, enemy:'mush', count:8,
      intro:['あら旅の人、うちは巡礼さん相手の宿屋なの。','巡礼さんはみんな魂の広場を目指すのよ。死んだ家族の魂が、一時あそこに還ると信じてね。','裏の森のマイコニドが食料庫を荒らして困ってるの。8体お願い!'],
      done:['助かったわ〜。そうだ、南の海の向こうに「深緑の社」があるの。','巡礼さんたちのもう一つの目的地よ。地図に描いてあげる。','…あなた、もしかして「還る人」?なら広場で、ヨネさんって巡礼さんを気にかけてあげて。'],
  ...
  b_dragon: [
    { id:'sq_gai2', npc:'npc_miner', npcName:'狩人ガイ', type:'mark', enemy:'lizard', rank:2, appearStory:'gai_code',
      markName:'紅鱗の主', mark:{ x:82700, y:9200 }, escortSpr:null,
      requiresStory:'gai_code', lockedLine:'…まずは色付き狩りの腕を見せてもらってからだ。',
      intro:['…見つけたんだ。相棒を殺った「紅鱗の主」を。','集落の南東の谷に潜んでる。地図に印を付けた。','掟には「紅は退け」とある。だがあいつだけは、退くわけにいかねえ。頼む。'],
    ...
    { id:'sq_ryu', npc:'npc_sage', npcName:'語り部リュウ', type:'hunt', enemy:'lizard', count:8,
      ...
      done:['静けさが戻った…では約束の続きを。竜が来た「霧の彼方」――','北の海に霧に包まれた小島がある。「霧の観測所」という村があると聞く。地図に記そう。','…竜どもはな、この世界を「環の世」と呼んだ。大陸が環をなして海に浮かび、環の外は終焉の潮ばかり…空を渡った竜だけが知る、世界のかたちよ。'],
      reward:{ coins:150, hintBase:'b_mist', story:'dragon_tale' } },
    { id:'sq_gai', npc:'npc_miner', npcName:'狩人ガイ', type:'hunt', enemy:'lizard', count:3, minRank:1, leaveStory:'gai_code',
  ...
  b_mist: [
    { id:'sq_mio', npc:'npc_scholar', npcName:'観測手ミオ', type:'hunt', enemy:'wisp', count:10,
      ...
      done:['観測できた!東に見えるあの灯り…「白亜の灯台」。竜骨の大陸の港街の灯りよ。','港には船着き場もあるはず。まとめて地図に描いておくわね。','うちの村はね、霧の切れ目を読んで、海峡を渡る船に報せるのが生業なの。この島の霧は、世界でいちばん深いから。'],
  ...
  b_dusk: [
    { id:'sq_sora', npc:'npc_girl', npcName:'吟遊詩人ソラ', type:'hunt', enemy:'bat', count:10,
      ...
      done:['ありがとう。お礼に、歌をひとつ。「南西の岬の黒曜の祠は、扉を開く詩を待つ」…','祠の扉を開ける合言葉の詩よ。祠の場所、地図に描いておくね。','この里の詩人はみんな、暮れない夕明かりに惹かれて流れてきたの。ここでは光が、ずっと詩を待っていてくれるから。'],
  ...
  b_frost: [
    { id:'sq_fuyu', npc:'npc_elder', npcName:'長老セツ', type:'hunt', enemy:'iceslime', count:10,
      ...
      done:['氷が澄んだ…礼に古い言い伝えを。「北東の海の雷鳴は嵐の塔の鐘の音」。','星嵐の大陸の北の果てに、塔の街がある。地図に記そう。','…わしらがこの凍る島を離れんのはな、氷が祖霊の祈りを封じたまま朽ちさせぬからじゃ。里は、その番人よ。'],
  ...
  b_spa: [
    { id:'sq_koko', npc:'npc_girl', npcName:'湯屋の看板娘ココ', type:'delivery', need:{ mats:{ hide:8 } },
      ...
      done:['わぁ、ふかふか!これでお客さん、湯冷めしないわ。','あなたはいつでも湯はタダでいいからね!','…軍勢のみんなも、湯気にあたっていきなさいな。','最近はね、白亜の灯台の街からもお客さんが来るのよ。夜の海に光の筋が見えたら、それが灯台なんだって!'],
      reward:{ coins:280 } },
  ],
  b_inn: [
    { id:'sq_maki', npc:'npc_miner', npcName:'薪割りのマキ', type:'hunt', enemy:'wisp', count:8,
      after:'…薪は足りてるか。あんたの分は、多めに割ってある。…それだけだ。',
      intro:['…薪割りのマキだ。口は重いが、腕は確かだ。','雪明かりに誘われてウィスプが寄ってきてな。囲炉裏の火を吸っちまう。','8体。頼む。'],
      done:['…助かった。','女将には内緒だが、あんたの分の薪は多めに割っておく。','…塔の連中が言ってた。嵐の晴れ間の東に、陽の色の海が見えると。','…それだけだ。'],
  ...
  b_moss: [
    { id:'sq_kina', npc:'npc_boy', npcName:'弟子のキナ', type:'delivery', need:{ mats:{ wood:10, jelly:5 } },
      ...
      done:['たすかった〜!これで今夜の膏薬が仕込める!','お礼にぼくの秘蔵の一瓶…はまだ早いから、こっちをあげる!','お師匠さまはね、墓標の村の弔い薬も作ってるんだよ。ぼく、いつか南へ届けに行くんだ!'],
      reward:{ coins:260 } },
  ],
  b_sea: [
    { id:'sq_shell', npc:'npc_boy', npcName:'貝の童シェル', type:'hunt', nearLoc:true, enemy:'crab', count:8,
      ...
      done:['わーい!これでいっぱい潜れる!','お礼にとっておきの貝、あげるね。','…あのね、巫女さまが言ってたの。『環礁の海の底は、最果ての海とつながってる』って。','ほんとかなあ。ほんとだったら、すごいよねえ。'],
  ...
  b_end: [
    { id:'sq_ou', npc:'npc_sage', npcName:'城主オウ', type:'hunt', enemy:'hornedimp', count:10,
      ...
      done:['見事だ。…では約束通り、余の話をしよう。','余の名はオウ。かつて――お前と同じ「死に戻り」であった。','幾百の生を重ね、広場に祭壇を築き、写本を残し、この果てまで辿り着いた。','その懐の切れ端。北の砦の兵に託したのは余だ。裏の字も、余の手よ。……よく、ここまで持ってきた。','砦の老兵が見た旅人も、遺跡の装置を調整した者も、鍛冶神に得物を打たせた者も…全て余だ。','還る魂と、還らぬ魂。その違いは、余にも分からぬ。ただ余もお前も、虚無の門をくぐらずに戻っておる。……二人だけの話では、法則とも呼べぬがな。','そして三十分。あれは世界の寿命ではあるまい。……誰かが決めた刻限のように、余には思えた。だが決めた者の顔は、ついぞ見ておらぬ。確かめる術も無いままじゃ。','だが終焉の刻の、その先へは…行けなんだ。だから余はここで、次の魂を待っておった。','余が越えられなかった終焉の刻を、超えてみせよ。その先で、また会おう。'],
...
DATA.QUESTS = {
  ...
  // --- 始まりの大陸 ---
  b_north: { npc:'npc_elder', npcName:'老兵ガルド', after:['おお、戻ったか。砦の火は今日も絶やしとらんぞ。'], type:'hunt', nearLoc:true, enemy:'skeleton', count:4,
    intro:['…おお、生きた人間か。ワシはこの砦の最後の守り兵じゃ。','砦の奥にはな、魂の広場へ通じる古いゲートが眠っておる。じゃが夜な夜な骸骨どもが湧いて、火を灯す暇もない。','奴らを4体、討ち払ってくれんか。ゲートの前だけでも静けさを取り戻したい。'],
    done:['見事じゃ…!これでゲートに火を灯せる。','…お前さん、「死に戻り」の魂じゃろう。死んでも魂があの広場に還って、鍛えた力ごと戻ってくる――そう聞いておる。ワシは見たままを言うだけじゃがな。','昔もう一人だけ、同じ魂を見た。魂の広場の祭壇を築いた御仁じゃ。','その御仁は「果ての城を目指す」と言い残して、消えた。…お前さんは二人目じゃよ。','見ろ、ゲートが灯った。お前さんの魂の広場と、この砦が繋がったんじゃ。いつでも戻ってこい。','…だがな、解せんことがある。先の御仁もお前さんも、死んで還る。ワシの部下たちは、誰ひとり還らなんだ。……何が違うんじゃろうな。'] },
  b_east: { npc:'npc_scholar', npcName:'考古学者リナ', after:['あ、おかえり!いま新しい碑文を写してたの。研究、ちゃんと進んでるわよ。'],
    afterIf:{ sun_mirror:['あっ、聞いた聞いた!東の海の金色、日輪の鏡の余り光だったのね!','三度の観測が、やっと繋がったわ。……でも待って。鏡が毎晩返す光なら、どうして三度しか見えなかったのかしら。観測を増やさなきゃ。'] }, type:'hunt', nearLoc:true, enemy:'goblin', count:4,
    intro:['きゃっ!?…な、なんだ人間か。私はこの遺跡を調べてる研究者。','この遺跡の正体はね、大昔の転送ゲート。魂の広場に繋がる装置なの。','なのにゴブリンたちがいじり回して…壊れちゃう前に4体追い払って!'],
    done:['助かった〜!…ほら、ゲートが目を覚ました。','これで魂の広場から直接ここへ来られるわよ。研究の成果、期待してて。','…ねえ、ひとつ気になってることがあるの。夜、東の海が金色に光ることがあるのよ。私の観測記録にも三度。原因は不明。','遺跡で手一杯で調べに行けないけど…あれ、何かあると思うのよね。三度も見たんだもの。'] },
  b_south: { npc:'npc_miko', npcName:'泉の巫女スズ', after:['お帰りなさいませ。泉は今日も澄んでいますよ。'], type:'survive', enemy:'slime', time:18,
    intro:['旅の方…この泉の底には、魂の広場へ通じる古いゲートが沈んでいるのです。','ですが泉が穢れて、ゲートの光が届かなくなってしまいました。','今から浄化の祈りを捧げます。18秒間、私を守ってください。'],
    done:['…祈りが届きました。泉が澄んで、底のゲートが光を取り戻しています。','この泉の加護、あなたの魂に結びました。いつでもお戻りください。','…ひとつだけ。泉の底のゲートは、私たちが沈めたものではありません。誰が、いつ沈めたのか。記録が一枚も残っていないのです。'] },
  b_west: { npc:'npc_smith', npcName:'鍛冶師ドバン', after:['おう、戻ったか!炉の火はいい按配だぜ。音を聞きゃ分かるだろ?'], type:'delivery', need:{ coins:20, mats:{wood:5, scrap:3} },
    intro:['おう、客か?街のゲートなら期待するな。火が落ちて、ただの鉄くれよ。','ありゃ炉の火を分けて灯す仕組みでな。まず炉に火を入れ直さにゃならん。','木材5・鉄クズ3、それと手間賃 🪙20。払ってくれりゃ、ゲートも灯してやるぜ。'],
    done:['よぉし、火が入った!見ろ、ゲートまで赤々と灯ってやがる。','この炉の音が聞こえる限り、ここはお前の家だ。','…そういやよ、この炉の火。誰が最初に入れたか知ってるか?俺の師匠も、そのまた師匠も知らねえ。火は最初から燃えてたんだとよ。おかしな話だろ。'] },
  // --- 第1環 ---
  b_dragon: { npc:'npc_elder', npcName:'竜骨の番人', after:['戻ったか。骨の灯は今日も太い。竜が覚えておる証じゃ。'], type:'hunt', nearLoc:true, enemy:'lizard', count:4,
    intro:['この集落のゲートはな、竜の骨を組んで建てられておる。','骨には今も竜の力が流れ、それがゲートを灯す。じゃがリザードマンどもが骨を喰らい、灯りが細る一方じゃ。','4体討て。さすればゲートは息を吹き返す。'],
    done:['骨をかじる音が止んだ…見よ、ゲートに竜の力が満ちていく。','竜はお前を認めたようじゃ。','…竜の骨は、いまも生きた声で鳴く。死んだ者が還らぬこの世で、骨だけがなぜ覚えておるのか。……問うても、骨は答えんわい。'] },
  b_dusk: { npc:'npc_sage', npcName:'黄昏の詩人ヨル', after:['やあ、おかえり。今日の夕明かりも、詩になりそうだ。'], type:'survive', enemy:'bat', time:21,
    intro:['ようこそ、夕暮れがずっと続く国へ。私は光を集めて詩を書く者。','この里のゲートは変わり者でね。正しい詩を聞かせてやらないと、目を覚まさないんだ。','今から目覚めの詩を詠む。詠み終わるまでの21秒、闇の獣から守っておくれ。'],
    done:['ああ…詩が届いた。ほら、ゲートが薄明かりの中で輝いてる。','君の旅路に、黄昏の祝福を。','…ひとつ、詩にできない話がある。この国の夕暮れは千年動いていない。夜も朝も来ないんだ。理由を知る者は、誰もいない。'] },
  b_star: { npc:'npc_miko', npcName:'星読みのミラ', after:['お帰りなさい。あなたの星は、今夜もよく輝いていますよ。'], type:'survive', enemy:'wisp', time:24,
    intro:['この祭壇のゲートは、星の光を集めて灯る仕組みなのです。','ですが星の光を喰らう精霊たちが集まって、灯りが点きません。','今から星灯りをゲートへ導く儀式を行います。24秒、私を守ってください。'],
    done:['…灯りました。星の光がゲートに届いています。','あなたの星は、とても強く輝いていますよ。','…星図に一つだけ、この空には無い星が記されています。先代から写し継がれた図です。その星を見た者は、誰もいません。'] },
  b_green: { npc:'npc_elder', npcName:'森の長オルガ', after:['戻ったかの。森は今日も、お前さんを「友」と呼んでおるよ。'], type:'delivery', need:{ coins:200, mats:{wood:20, hide:10} },
    intro:['この森は生きておる。よそ者の使うゲートなど、木の根で覆って封じてしもうた。','…だが、森への捧げ物があれば根も解けよう。','木材20・毛皮10・🪙200。森の掟じゃよ。'],
    done:['よかろう。…ほれ、根がゲートから離れていく。','森はお前を「友」と認めた。','…森は覚えておるよ。ずっと昔、この森を歩いた「還る魂」のことをな。お前さんで二人目じゃ、と木々が言う。……では一人目は、どこへ行った?木々は、そこから先を言わん。'] },
  b_white: { npc:'npc_sailor', npcName:'灯台守ハク', after:['おう、戻ったか。灯りは今夜も真っ直ぐ伸びとるわい。'], type:'hunt', nearLoc:true, enemy:'crab', count:4,
    intro:['この灯台の光はな、沖の船だけでなく、麓の広場のゲートも灯しておるんじゃ。','なのにアイアンクラブどもが土台を齧って、光が揺れる揺れる。','4匹叩き落としてくれ。灯りが消えりゃ、ゲートも眠っちまう。'],
    done:['…見ろ、この光だ!まっすぐ伸びて、ゲートまで届いとる。','海の果てまで照らしてやるわい。ありがとうな。','…この灯りな、油を差した覚えがねえのに消えんのじゃ。ワシの代でも、親父の代でもな。……では誰が注いどる?ワシは一度も、その姿を見たことがない。'] },
  b_black: { npc:'npc_sage', npcName:'黒曜の修行僧', after:['…戻ったか。祠は静かだ。それでいい。'], type:'hunt', nearLoc:true, enemy:'wisp', count:5,
    ...
    done:['…見事な太刀筋。祠は静けさを取り戻し、ゲートが開いた。','この祠はお前の心の拠り所となろう。','…静けさの底で、時おりこう聞こえる。「まだ足りぬ」と。誰の声かは、まだ分からぬ。修行が足りぬのだ。'] },
  b_spa: { npc:'npc_elder', npcName:'湯守のゴエ', after:['おう、いい頃合いだ。湯加減は上々よ。浸かってきな。'], type:'hunt', nearLoc:true, enemy:'lavaslime', count:5,
    ...
    done:['おお、湯がちょうどよくなった。…ほら、ゲートも湯気の向こうで灯ってるだろ。','ゆっくりしていきな。湯は逃げねえ、魔物も湯の中までは追ってこねえよ。','…湯には言い伝えがあってな。「湯に浸かった魂は還りやすい」と。あんたを見て、迷信だという気が失せた。……だがなぜ湯なんだ?そこだけは、誰に聞いても知らねえのさ。'] },
  b_inn: { npc:'npc_girl', npcName:'宿場の女将トウカ', after:['おや、おかえり。囲炉裏の席は空けてあるよ。'], type:'delivery', need:{ coins:400, mats:{wood:15, hide:6} },
    ...
    done:['ありがとうね。ほら、囲炉裏が燃えて…ゲートにも火が回った。','峠を渡る者はみんなここで一息つく。あんたの席は、いつでも空けておくよ。','…毎年ひとり、峠を越えて北へ行ったきり戻らない客がいるんだよ。宿帳に名前だけが残ってね。もう三十年、ずっとさ。'] },
  b_moss: { npc:'npc_miko', npcName:'薬師のモグサ', after:['…おや、戻ったかえ。釜の火はいい塩梅じゃよ。'], type:'hunt', nearLoc:true, enemy:'mush', count:6,
    intro:['…おや。こんな森の奥まで、よう来たの。ここは苔の庵…わしは薬師のモグサじゃ。','庵のゲートは薬釜の火で灯すんじゃがの、マイコニドが薬草園を荒らして、釜にくべる香草が育たん。','6体、森へ帰しておくれ。倒せば胞子も静まるでの。'],
    done:['…園が静かになった。どれ、釜に火を入れて…ほれ、ゲートが灯ったわい。','傷をこさえたら、いつでも寄りなされ。膏薬を塗ってやろう。','…この森の薬草はな、どれも「還り」に効くと伝わっとる。何から還るのか、書いた者はもうおらんがの。'] },
  // --- 中間の小島 ---
  b_mist:  { npc:'npc_sage', npcName:'霧の番人', after:['戻ったか。今日は霧が薄い。…良い日じゃよ。'], type:'survive', enemy:'bat', time:21,
    intro:['霧は全てを隠す…この村のゲートさえもな。','観測所の鏡で霧の切れ目を読めば、ゲートまで光を通せる。じゃが、その観測所が壊れておっての。','今から直しに行く。21秒間、霧の獣から守ってくれ。'],
    done:['直った…見ろ、霧が割れてゲートが姿を現した。','お前には、この島の全てが見えるだろう。','…霧の切れ目に、島がもう一つ見えることがある。どの地図にも無い島じゃ。近づこうとすると、霧が戻る。'] },
  b_bones: { npc:'npc_smith', npcName:'骨商人ザリ', after:['へっへっへ、また来たな。今日も骨の相場は上々よ。'], type:'delivery', need:{ coins:500, mats:{bone:18, hide:8} },
    intro:['へっへっへ…こんな荒野に客とは珍しい。','ここのゲートを見たか?骨組みが半分崩れて、ありゃ灯らねえよ。','ワシは骨を商う者。骨18・毛皮8、手間賃🪙500で、ゲートの骨組みを組み直してやろう。'],
    done:['まいどあり!ほれ、見事な骨組みだろう。ゲートも灯った。','ここはアンタの取引所だ。','へっへ…骨の相場でな、近ごろ妙なんだ。西の果てから流れてくる骨が、どれも同じ日に死んだような傷み方をしとる。……ワシの目が確かならな。'] },
  b_ember: { npc:'npc_smith', npcName:'火の子エン', after:['あっ、おかえり!おばあちゃんの火、今日も元気だよ!'], type:'hunt', nearLoc:true, enemy:'orc', count:4,
    intro:['この島のゲートはね、おばあちゃんの形見の火で灯ってるんだ。','でもオークたちがその火を消そうとしてる!火が消えたら、ゲートも消えちゃう!','4体やっつけて!お願い!'],
    done:['やったー!火が守られた!ゲートの灯りも、ほら、あんなに明るい!','あんた、かっこいいね!','…ねえ。おばあちゃんの火ってさ、おばあちゃんが生まれる前からあったんだって。じゃあ、誰の火なの?'] },
  b_frost: { npc:'npc_miko', npcName:'氷の隠者フユ', after:['…お帰りなさい。氷は今日も、澄んだ音で鳴いています。'], type:'survive', enemy:'wisp', time:21,
    intro:['…寒いでしょう。ここは時が凍る島。ゲートも厚い氷の中で眠っています。','これから氷を解かす祈りを捧げます。','21秒…氷の精霊たちから、私を守ってくださいな。'],
    done:['…ありがとう。ほら、氷が解けて、ゲートが息をしています。','この祠の氷は、もうあなたを拒みません。','…氷の奥に、人がひとり閉じ込められています。解かしても、翌朝にはまた凍っているのです。……顔は、見ない方がよいでしょう。'] },
  // --- 第2環 ---
  b_forge: { npc:'npc_smith', npcName:'鍛冶神の弟子ゴウ', after:['よう、戻ったか。聞こえるだろ、金床の歌。今日も上機嫌だぜ。'], type:'delivery', need:{ coins:3000, mats:{scrap:25, magic:5} },
    ...
    done:['聞こえるか?金床が歌ってる。ゲートの骨組みも打ち直した。','神の工房はお前を歓迎している!','…師匠は溶岩の底で「眠っている」。死んだとは誰も言わねえ。迎えに行った奴も、まだ誰も戻ってねえけどな。'] },
  b_moon:  { npc:'npc_sage', npcName:'月の使者ツクヨ', after:['よう戻った。今宵の月も、欠けてはおらぬよ。'], type:'hunt', nearLoc:true, enemy:'knight', count:4,
    intro:['この社のゲートは、月の光を浴びて灯る。','だが月影に巣食う闇の騎士どもが、その光を喰らっておるのだ。','4体、斬っておくれ。月光が戻れば、ゲートも目を覚まそう。'],
    done:['月光が戻った…ゲートが青白く灯っておる。','社はお前に開かれた。','…この月は欠けぬ。社が建ってから一度もな。……なぜ欠けぬのか。禁書はその問いを書いた頁で、ぷつりと途切れておる。誰が破いたのかも分からぬ。'] },
  b_storm: { npc:'npc_scholar', npcName:'嵐の観測士ライ', after:['おう戻ったか!今日は風が読みやすい。いい日だぞ!'], type:'survive', enemy:'wisp', time:25,
    intro:['来たか!ちょうどいい!この塔のゲートは、雷が落ちるたびに壊れちまう。','今から避雷針をゲートの上に立て直す!雷雲の芯が通り過ぎる25秒間、機材を守ってくれ!','死ぬなよ!'],
    done:['付いたぞ!もうゲートに雷は落ちん!','世紀の大工事だ!塔はお前にも開放する!','…なあ、ついでに一つ妙な話をしていいか。この塔の鐘、誰も触れてないのに鳴ることがある。','決まって、どこかで魔物の大群が動き出す前の晩だ。……何かが来るのを、塔が先に知ってるみたいでな。理由は俺にも分からん。'] },
  b_grave: { npc:'npc_sage', npcName:'墓守グレイ', after:['戻ったか。今日も死者はよく眠っている。いい日さ。'], type:'hunt', nearLoc:true, enemy:'necro', count:3,
    intro:['ここは魔界との境…死者が安らかに眠るべき村さ。','だがネクロマンサーどもが死者を弄び、その澱んだ気配がゲートの光を塞いでいる。','3体でいい。奴らは逃げ足が速いぞ。'],
    done:['澱みが晴れて、ゲートの光が戻った。','…終焉の刻が来るたび、荒野はリーパーの大群に呑まれる。呑まれた亡骸は、光の残るこの村へ運ばれてくるのさ。','ここはそういう村…死者を弔う、世界の受け皿だ。','死者たちも感謝している。この村はお前の味方だ。','…だがな、運ばれてくる亡骸に、まだ息をしている者が混じることがある。そういう奴は、翌朝には消えているのさ。'] },
  // --- 第3環 ---
  b_sun:  { npc:'npc_miko', npcName:'太陽の神官サナ', after:['お帰りなさい。太陽は今日も、あなたを見ていましたよ。'], type:'hunt', nearLoc:true, enemy:'lizard', count:5,
    intro:['ようこそ、灼けつく神殿へ。この都のゲートは、日輪の鏡が集めた陽の光で灯ります。','ですがリザードマンが鏡の間に巣食い、光を遮っているのです。','5体討つこと。それが入信の儀式です。太陽はすべてを見ていますよ。'],
    done:['光が通りました。ご覧なさい、ゲートが黄金に輝いています。','太陽はあなたを祝福しました。神殿の力をお使いなさい。','…日輪の鏡は、時おりあなたの後ろを映します。そこには誰も立っていないのに。太陽は、すべてを見ていますから。'] },
  b_void: { npc:'npc_sage', npcName:'虚無の囁き', after:['……来たか。静けさは、保たれておる。'], type:'hunt', nearLoc:true, enemy:'demon', count:5,
    intro:['……来たか。ここは在って無い場所。','この庵のゲートは、完全な静けさの中でだけ開く。だがデーモンが5体、騒がしくてかなわん。','排せ。さすれば道は開く。'],
    done:['……良い。静けさが戻り、ゲートが開いた。','虚無はお前を通す。','……ひとつだけ言う。死んだ魂は皆この門をくぐり、二度と戻らぬ。この庵が「虚無の門」と呼ばれるのは、そのためだ。','……だがお前は、くぐらずに戻ってきておるように見える。なぜかは、ここでは分からぬ。'] },
  b_sea: { npc:'npc_miko', npcName:'海の巫女ルカ', after:['お帰りなさい。都の灯りが、あなたに揺れて応えています。'], type:'survive', enemy:'siren', time:20,
    requiresStory:'umi_dive',
    lockedLine:'「…あなた、どうやってここへ?」巫女は警戒して歌おうとしない。白亜の灯台の潜り漁師の口添えが要るようだ。',
    intro:['ようこそ、波の上の環礁へ。この足元に、私たちの都が沈んでいます。','都と魂の広場を繋ぐゲートは、この環礁の祭壇から潮の歌で灯すのです。','今から歌います。歌い終わるまでの20秒、海の魔物から私を守ってください。'],
    done:['…歌が届きました。ご覧なさい、海の底からゲートの光が昇ってきます。','沈み都は、あなたを客人として迎えます。','…沈む前、この都は「還らぬ者たちの街」と呼ばれていました。なぜそう呼ばれたのか、歌にすら残っていません。'] },
  b_end:  { npc:'npc_elder', npcName:'最果ての賢者', after:['…戻ったか。碑は今日も、お前の魂を覚えておるよ。'], type:'survive', enemy:'reaper', time:25,
    ...
    done:['…見届けた。碑がお前を覚え、ゲートが繋がった。','30分――それがこの環の世の限界じゃ。刻が満ちれば、世界の縁からリーパーの大群が押し寄せ、全てを刈り取っていく。','人里がゲートの光の下にしか残っておらんのは、そのせいよ。','…かつて一人、お前と同じ目をした者がこの碑を越え、城へ入った。戻っては来なんだ。','その先に何があったかは、城の主に聞くがいい。お前こそ、終焉に抗う者じゃ。'] },
};
...
// 海岸伝いに灯台の光を目で追って、自分で見つける手がかりになる
const PORT_SMITH = {
  // open→req(依頼)→fix(完成の一声)→close→mate まで、8人それぞれの声で通す(共通文なし)
  p_e:  { name:'船大工タル', open:'おう、あの船かい?嵐で浜に打ち上がってたのを、俺が引き取ったんだ。', req:'直してほしけりゃ材料と手間賃だ。話はそれからだぜ。',
          fix:'…よし、直った!マストも帆も新品同様だ。', close:'初めての航海にゃもってこいの船に仕上げたぜ。良い風を!',
          mate:'そうだ、海岸を北へ辿りゃ北東の、南へ下りゃ南東の浜にも船乗り仲間がいる。夜通し回ってる灯台の光が目印だ。' },
  p_ne: { name:'船大工ナギ', open:'ん?あの船が気になるか。持ち主は嵐の晩に消えちまってな…俺が預かってる。', req:'直すなら材料と手間賃を頼む。あいつの船だ、手は抜けない。',
          fix:'…直ったよ。マストも帆も、あの頃のままだ。', close:'これでどこへでも行ける。あいつの分まで、遠くへ乗ってやってくれ。',
          mate:'海岸沿いの南と、ずっと北の浜にも、あいつの船乗り仲間の港がある。灯りが回ってたら、それが港だ。…よろしく伝えてくれ。' },
  p_n:  { name:'船大工フブキ', open:'寒いだろう。まず焚き火にあたってきな…と言いたいが、あの船の話か?', req:'材料と手間賃を持っといで。火にあたりながら待っててもいいぞ。',
          fix:'よし、直った!北の海でも軋みゃしない。', close:'北の海仕様に締め直した。氷を割って進め!',
          mate:'この寒空の下、西どなりと東どなりの浜でも港の連中が火を焚いとる。海岸伝いに灯台の光を辿れば着くさ。寄ったら温まっていきな。' },
  p_nw: { name:'船大工キリ', open:'霧の港へようこそ。あの船は霧で座礁したのさ。骨組みは無事だがね。', req:'材料と手間賃を揃えておくれ。霧が晴れる間に仕上げるさ。',
          fix:'…直ったよ。骨組みから締め直してある。', close:'霧笛も付けといた。迷ったら音を頼りにな。',
          mate:'海岸を南へ下れば西の港、東へ回れば北の港さ。霧の日はどこも見えないがね…灯台の光だけは霧を貫くんだ。' },
  p_w:  { name:'船大工ユウ', open:'夕日が綺麗だろう、ここは。あの船は親父の形見でな…直す金がなかったんだ。', req:'材料と手間賃を頼む。親父の船だ、良い仕事をさせてくれ。',
          fix:'…直ったぜ。親父も文句は言うまい。', close:'親父の船がまた海に出るとはな。あんたのおかげだ。',
          mate:'親父の代からの馴染みが、南の浜と北の浜の港にいる。海岸沿いに灯りを辿って、夕日の話でもしてやってくれ。' },
  p_sw: { name:'船大工セイ', open:'船を探してるんだって?ちょうどいい、直し手のない船が一隻あるんだ。', req:'材料と手間賃、耳を揃えてくれたら請け負うよ。',
          fix:'よし、仕上がった!隅々まで見ていきな。', close:'黄昏の大陸まで保証付きだ。行ってきな!',
          mate:'海岸を東へ回れば南の港、北へ上れば西の港がある。航路は商売の道…灯台の光の筋が見えたら、港は近いよ。' },
  p_s:  { name:'船大工アラシ', open:'嵐の海を渡りたいってのか?物好きだねえ。なら船も嵐仕様に直さんとな。', req:'材料と手間賃を持ってきな。嵐仕様は手間がかかるんだ。',
          fix:'よし、直った!帆桁も嵐仕様に組み替えてある。', close:'嵐で軋んでも壊れやしない。自慢の仕事だ。',
          mate:'東どなりと西どなりの浜にも港がある。嵐に流されたら、灯台の光が回ってる方へ舵を切りな。' },
  p_se: { name:'船大工ハヤテ', open:'速い潮を乗りこなす船が要るんだろう?任せな、腕は南東一だ。', req:'材料と手間賃だ。速い仕事は材料次第なんでね。',
          fix:'直したぜ。どこよりも速く仕上げた。', close:'流れに乗れば矢のように走る。振り落とされるなよ!',
          mate:'海岸の北に東の港、西に南の港がある。速い船乗りってのは、灯りを一目見りゃ港が分かるもんさ。' },
  p_white: { name:'船大工シラホ', open:'おう、灯台の下の船かい?ありゃ港街の誇りだった白帆でな、直し手を待ってたのさ。', req:'材料と手間賃を頼むよ。灯台守のじいさんも待ちわびてる。',
          fix:'仕上がった!灯台の光に負けねえ白い帆だ。', close:'霧の海でも太陽の海でも、この船なら渡り切れる。',
          mate:'うちの灯台の光は世界一遠くまで届く。北の霧、北東の太陽…光の筋の先に、海の道が通ってるぜ。' },
  p_storm: { name:'船大工ライガ', open:'嵐でマストの折れた船だ。骨は良いんだがな、直し手がいなかった。', req:'材料と手間賃だ。嵐の合間に一気に仕上げるぞ。',
          fix:'できたぞ。雷が落ちても折れんマストだ。', close:'鐘が鳴ったら出航はよせ。晴れ間を待って走れ!',
          mate:'北へ出りゃ最果ての海、東へ走りゃ太陽の海。どっちも早瀬が通ってる。灯台の光を離すなよ。' },
  p_moon: { name:'船大工ツキ', open:'…この船を、直しに来たのですね。月を渡る船、と呼ばれています。', req:'材料と手間賃を。急ぎません…月は逃げませんから。',
...
for (const p of DATA.PORTS) {
  ...
  DATA.QUESTS[p.id] = {
    npc:'npc_sailor', npcName:(PORT_SMITH[p.id] && PORT_SMITH[p.id].name) || '船大工', type:'delivery', need:p.repair,
    intro:[sm.open, PORT_FLAVOR[p.id] || '海はいいぞぉ。',
      ...
      .concat(['(港の常夜灯にゲートの分け火が灯った ― 魂の広場から、この港へも出撃できる)']) };
}

// 2段階目クエスト(基地解放後、NPCに再度話すと受けられる追加依頼。報酬つき)
DATA.QUESTS2 = {
  b_north: { npcName:'老兵ガルド', offer:'実はな…砦の周りにウルフの群れが居着いてしもうた。狩ってくれんか?',
    type:'hunt', nearLoc:true, enemy:'wolf', count:8,
    intro:['すまんな、何度も。ウルフどもが物資を狙っておる。','8頭。頼んだぞ。'],
    done:['助かった!これで安心して眠れるわい。','…戦いの中で、倒した魔物が付いてくるのを見たか?あれは「魂の共鳴」。澄んだ魂は、お前の魂と響き合って仲間になるんじゃ。','体を借り直しただけで中身は同じ魂。じゃから同じ種類なら、敵であれ仲間であれ強さも同じよ。','礼にワシの戦術を授けよう。仲間を率いる「誓い」の技じゃ。','(スキル「老兵の誓い」を習得できるようになった!)','武具庫の錆も落としておいたぞ。(この基地のパワーアップ施設が使えるようになった!)'],
  ...
  b_east: { npcName:'考古学者リナ', offer:'遺跡の最深部を調査したいの。護衛、お願いできない?',
    ...
    done:['解析完了!…すごいわ、これ身体能力を強化する術式よ。あなたにも使えるはず。','いい?素材は魔物の力のかたまり。それを組み合わせて身に宿すのが「スキル」。','ただし宿せるのは旅の間だけ。死ねば力は抜けてしまう。でも宿し方のコツは魂に残るわ。各地の書庫の写本は、それを磨くためのもの。','…それとね、この装置、誰かが先に調整した跡があったの。手つきが、あなたによく似てる。','断定はできないけど…あなたと同じ魂の人が、先にここへ来たんじゃないかしら。この写本の何冊かも、その人のものかも。','最深部の装置も動き出したわ。(この基地のパワーアップ施設が使えるようになった!)'],
  ...
  b_west: { npcName:'鍛冶師ドバン', offer:'デカい仕事が入ってな。材料を都合してくれりゃ分け前をやるぜ。',
    ...
    intro:['西方交易のゴルドの旦那から、大口の発注が入ってな。納期がやべえ。','鉄クズ12・木材12・つなぎの🪙100。頼む!'],
    done:['っしゃあ!間に合った!ほらよ、分け前だ。','(報酬を受け取った!)','品はここから西の浜の港町まで運んで、船で黄昏の大陸へ送るんだ。だいたいの見当を描いといてやる…夜なら灯台の灯りですぐ分かるぜ。','ついでにお前さん用の炉も火を入れといた。(この基地のパワーアップ施設が使えるようになった!)'],
    reward:{ coins:500, mats:{magic:4}, hintPort:'p_w' } },
};
...
Object.assign(DATA.QUESTS2, {
  b_dragon: { npcName:'竜骨の番人', type:'mark', enemy:'lizard', rank:1,
    markName:'祭具喰らいのリザード', mark:{ x:82000, y:7100 },
    offer:'祭具を呑んだ奴の居所が分かった。取り返してくれんか。',
    intro:['祭具を呑んだ金鱗のリザードが、集落の北東の岩場に居着いておる。','地図に印を付けておいた。腹の中の祭具ごと、取り返してくれ。'],
    done:['祭具が戻った…!竜の力が集落に流れ出す。','(この基地のパワーアップ施設が使えるようになった!)'],
    reward:{ coins:300 } },
  b_star: { npcName:'星読みのミラ', type:'mark', enemy:'wisp', rank:1,
    markName:'星喰いの長', mark:{ x:-16000, y:-56700 },
    offer:'星水晶を吸っているのは、ただのウィスプではありません。長がいます。',
    intro:['祭壇の光を吸い続ける「星喰いの長」…金色に肥え太ったウィスプです。','丘の上に現れます。地図に印を。どうか、討ってください。'],
    done:['星水晶が輝きを取り戻した…祭壇が星の力を注いでくれます。','(この基地のパワーアップ施設が使えるようになった!)'],
    reward:{ coins:350 } },
  b_forge: { npcName:'鍛冶神の弟子ゴウ', type:'mark', enemy:'golem', rank:1,
    markName:'暴走した大炉のゴーレム', mark:{ x:219100, y:-56900 },
    offer:'大炉を占拠してる馬鹿デカいゴーレム、あれを止めてくれ。',
    intro:['大炉の番をさせてたゴーレムが、熱にやられて暴走しちまった。','壊すしかねえ…親方が打った奴だ、せめて一撃で楽にしてやってくれ。地図に印を付けといた。'],
  ...
  b_sun: { npcName:'太陽の神官サナ', type:'mark', enemy:'scarab', rank:2,
    ...
    done:['日輪が輝きを取り戻しました。太陽の力が都に満ちる。','…そうそう。東の学者どのが「夜の海が金色に光る」と騒いでいたそうですね。あれは日輪の鏡の仕業です。','鏡は昼のあいだ陽の光を溜め、夜、余った光を海へ返すのです。東の海が金色に揺れるのは、この都が生きている証。','どうか学者どのに伝えてあげてください。太陽はすべてを見ていますよ。','(この基地のパワーアップ施設が使えるようになった!)'],
    reward:{ coins:600, story:'sun_mirror' } },
  b_void: { npcName:'虚無の囁き', type:'survive', enemy:'voidwisp', time:25,
    offer:'……庵の静けさを、一度だけ完全に満たしたい。',
    intro:['……今から庵の心臓で「無」を編み直す。','25秒。何者にも邪魔をさせるな。'],
    done:['……戻った。この庵の力を、お前にも分けよう。','……ときに。嵐の塔の鐘が、独りでに鳴るわけを知りたくはないか。','あれは終焉の潮騒に共鳴しておる。リーパーの群れが世界の縁で膨らむとき、世界はわずかに軋む……この庵の静けさの底では、そう聞こえる。','鐘が鳴った夜は、備えよ。……世界の終わりは、いつも音から始まる。','(この基地のパワーアップ施設が使えるようになった!)'],
    reward:{ coins:550 } },
});
...
{
  // [敵, 数, 困りごと(その人の口調), 達成の言葉(同), 受注の言葉2行(同)]
  // 受注の言葉は必ずその人物の口調で書く。共通文の使い回しはしない
  const FACQ = {
    b_dusk:['bat',7,'里の歌碑が、コウモリの巣にされてしまってね。','歌碑が響きを取り戻した。ほら、詩の力が里に満ちていく。',
      'コウモリを7匹、歌碑から追い払っておくれ。','歌が戻れば、この里の施設も目を覚ますはずさ。'],
    b_green:['boar',6,'社の御神木の根を、イノシシどもが荒らしおってな。','御神木が安らいだわい…森の恵みが社に巡り始めよる。',
      'イノシシを6頭、追い払ってくれんかの。','御神木が安らげば、社の力もお前さんに応えてくれよう。'],
    b_white:['crab',6,'灯台の基部にアイアンクラブが張り付いて、光が歪むんじゃ。','光が真っ直ぐ伸びた。灯りの力が街を照らす。',
      'アイアンクラブを6匹、叩き落としてくれ。','光が真っ直ぐ戻りゃ、街の施設も動き出すわい。'],
    b_black:['shade',6,'祠の御神体の黒曜石に、シェイドが取り憑いてしまった。','御神体が静まった…黒曜の力が祠に戻る。',
      'シェイドを6体、斬れ。','御神体が静まれば、祠の力もお主に開かれよう。'],
    b_mist:['wisp',7,'観測レンズが霧の精に曇らされてな。','レンズが澄んだ。観測の知が村の力になる。',
      '霧の精を7体、払ってくれんか。','レンズが澄めば、観測の知恵もお前さんの力になる。'],
    b_bones:['skeleton',8,'掟破りの骸骨が祭場を荒らす。','祭場が清まった。祖霊の加護が野営地に宿る。',
      '掟破りの骸骨を8体、片してくれや。','祭場が清まりゃ、施設も商いも回り出すって寸法よ。'],
    b_ember:['lavaslime',6,'御神火 ― おばあちゃんの火に、ラヴァスライムが飛び込んで火が濁っちゃったんだ。','御神火が澄んだよ!火の民の力、きみにも分けてあげる!',
      'ラヴァスライムを6匹、やっつけて!','御神火が澄んだら、火の民の力を分けてあげる!'],
    b_frost:['iceslime',7,'氷の祭壇が、スライムの粘りで汚れてしまいました。','祭壇の氷が透き通りました…霜の加護が里に満ちていきます。',
      'アイススライムを7体、鎮めてくださいな。','祭壇が透き通れば、霜の加護があなたにも届きますよ。'],
    b_storm:['stormwisp',6,'鐘楼にストームウィスプが巣食って、鐘が鳴らせねえんだ。','鐘が鳴った!聞こえるか、嵐の力が塔に満ちてくるぞ!',
      'ストームウィスプを6体、片づけてくれ!','鐘が鳴りゃ、塔の観測設備も目を覚ますって寸法だ!'],
    b_grave:['mummy',6,'安置所のマミーが目を覚ましてしまった。','死者が再び眠った…弔いの加護が村に宿る。',
      '目覚めたマミーを6体、眠らせてやってくれ。','死者が再び眠れば、弔いの加護がお前に宿る。'],
    b_end:['hornedimp',8,'玉座の間にデーモンが居座っておる。','玉座が清められた。最果ての力がお前に開かれる。…ときにな、この最果ての海は、深みで南の環礁…沈み都の海と繋がっておる。世界の海はひとつの環。終焉の潮も、その環を巡って縁に満ちるのじゃ。',
      'ホーンドデーモンを8体、討ち払え。','玉座が清まれば、最果ての力がお前に開かれるじゃろう。'],
    b_sea:['crab',7,'都へ空気を送る泉に、アイアンクラブが挟まって詰まってしまったのです。','泉が息を吹き返しました…都の力が、あなたにも流れ込みます。…この都は、遠い昔の終焉の刻に海へ呑まれました。それでもゲートの光が消えなかったから、海の底でいまも息をしているのです。',
  ...
  for (const b of DATA.BASES) {
    ...
    const f = FACQ[b.id] || ['slime', 6, 'この土地の施設が魔物に荒らされている。', '施設が静けさを取り戻した。',
      'スライムを6体、退治してもらえないか。', '静けさが戻れば、施設も目を覚ますだろう。'];
    DATA.QUESTS2[b.id] = {
      npcName: DATA.QUESTS[b.id].npcName,
      offer: f[2],
      type: 'hunt', nearLoc: true, enemy: f[0], count: f[1],
      intro: [f[4], f[5]],
...
// 先人の手記: 見晴らし台に一頁ずつ残されている、先代の死に戻りの旅の記録。
// 順番に見つかる。城主オウ・老兵ガルド・考古学者リナ・弟子ハガネらが語る「先人」の一人称。
DATA.MEMOIRS = [
  '「一頁目 ― 気がつくと、草原に立っていた。ポケットに地図の切れ端。……いつか私と同じ書き出しの旅人が、これを読むのだろうか」',
  '「二頁目 ― 死んだ。そして広場で目覚めた。石を積んで祭壇を組んでみる。魂は、鍛えたぶんだけ憶えているらしい」',
  '「三頁目 ― 倒した魔物が、ついてきた。魂が響き合うのだと砦の老兵は言う。……もう、独りではない」',
  '「四頁目 ― はじめて海を渡った。振り返ると、灯台の光が思っていたよりずっと優しかった」',
  '「五頁目 ― 色を変えた魔物に軍勢を半分溶かされた。金は挑め、紅は退け。狩人の掟は正しい」',
  '「六頁目 ― 嵐の塔の鐘が鳴った日、東の海が金色に光った。世界は、まだ広い」',
  '「七頁目 ― 30分。それがこの世界の限界。リーパーの大群は誰にも止められない。だが、碑まで辿り着ければ……」',
  '「八頁目 ― 虚無の隠者は言った。全ての魂は門を通る、と。ならば私は、門の先を見に行く」',
  '「九頁目 ― 明日、果ての城に入る。戻れない気がする。だからこの手記を、見晴らし台の岩の割れ目に残していく」',
  '「十頁目(最後の頁)― もし君が、私と同じ魂なら。城で待っている。終焉に抗う方法は、二人なら見つかるかもしれない」',
];

// 手記コンプの報い: 全頁を見つけてから城主オウに会うと、後日談が変わる
// (集めた断片が本人の元で結実する ― 断片語りの締め)
DATA.MEMOIR_OU = [
  '…その懐。見晴らし台に残した頁が、全て揃っておるな。',
  '置き去りにした余の言葉を、次の魂が一頁ずつ拾うて、ここまで運んでくれた。……これほどの救いはない。',
  '十頁目に書いた通りじゃ。終焉に抗う方法は、二人なら見つかる。――共に、その先へ。',
];
...
DATA.EPILOGUE = {
  ...
  b_west:  'ゴルドの大口発注より、お前さんの得物を打つ方が名誉ってもんだぜ。',
...
DATA.NPC_TIPS = [
  ...
  '旗の立つ見晴らし台に登ると、あたりの地形が地図に刻まれる。岩の割れ目に古い手記が挟まっていることもあるそうだ。',
  '野に石積みの祠を見かけたら祈ってみろ。古の加護がしばらく宿る。ただし霊験は一度きりだ。',
  '火の消えた野営跡や折れた剣の塚…あれは昔、果てを目指した御仁の旅の跡らしい。辿ってみたくなるだろう?',
  '紅より濃い色の魔物は長生きのぶん蓄えを持っていて、倒すと宝箱を落とす。開ける瞬間がたまらんのだ。',
  '夜の東の海が金色に光ることがあるらしい。理由を知る者は…さて、東の遺跡の学者さんも首をひねっていたな。',
  '年寄りは世界を「環の世」と呼ぶ。大陸は環をなし、環の外は終焉の海ばかりだとさ。',
...
DATA.FAC_STATE = {
  ...
  b_spa:   { tag:'湯壺の岩組みが崩れている', look:['湯壺の岩組みが崩れ、湯が細くしか湧いていない。','岩にはリザードマンの爪痕が残っている…'] },
  b_inn:   { tag:'薪小屋が凍りついている',   look:['囲炉裏に焚く薪の小屋が、氷にびっしり覆われている。','戸の隙間から、冷たい風が吹き出してくる…'] },
  b_moss:  { tag:'薬草の釜が眠っている',     look:['薬草を煮出す釜が、火を落としたまま苔むしている。','干した薬草だけが、棚で出番を待っている…'] },
};
