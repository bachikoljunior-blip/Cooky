...
DATA.QUESTS = {
  ...
  b_black: { npc:'npc_sage', npcName:'黒曜の修行僧', type:'hunt', enemy:'wisp', count:5,
    intro:['…この島の闇は、心を映す鏡。','彷徨える光魂(ウィスプ)が5つ、闇を乱している。','斬れ。それがお前の修行だ。'],
  ...
  b_void: { npc:'npc_sage', npcName:'虚無の囁き', type:'hunt', enemy:'demon', count:5,
    intro:['……来たか。ここは在って無い場所。','デーモンが5体、虚無を喰い荒らしている。','排せ。さすれば「無」がお前に道を開く。'],
    done:['……良い。虚無はお前を通す。'] },
...
DATA.FAC_STATE = {
  ...
  b_black: { tag:'契約石が憑かれている',   look:['祠の契約石が、黒い靄にまとわりつかれている。','近づくと、ひやりとした悪意が肌を撫でた…'] },
  ...
  b_void:  { tag:'静寂が乱れている',       look:['庵の静寂が乱れ、空間がわずかに軋んでいる。','これでは「無」の理に触れることはできない…'] },
