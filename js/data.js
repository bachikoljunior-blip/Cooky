...
DATA.SIDEQUESTS = {
  ...
  b_north: [
    { id:'sq_hanna', npc:'npc_girl', npcName:'村娘ハンナ', type:'hunt', enemy:'slime', count:8,
      ...
      done:['すごい!これで冬を越せるわ。','…あなたの後ろの魔物さんたち、最初は怖かったけど。結界を素通りしてくるってことは、敵意がないのよね。','…そういえば地図職人のトトさんが、あなたみたいな人を探してたわよ。'],
  ...
  b_east: [
    { id:'sq_kilo', npc:'npc_boy', npcName:'見習い研究員キロ', type:'hunt', enemy:'goblin', count:10,
      ...
      done:['資料が戻ってきた!ありがとう!','この天文資料…北の空の「星降りの大陸」の記述だ。地図に写しておくね。'],
  ...
  b_south: [
    { id:'sq_mama', npc:'npc_girl', npcName:'宿屋の女将マーサ', type:'hunt', enemy:'mush', count:8,
      intro:['あら旅の人、うちは巡礼さん相手の宿屋なの。','巡礼さんはみんな魂の広場を目指すのよ。死んだ家族の魂が、一時あそこに還ると信じてね。','裏の森のマイコニドが food…じゃなくて食料庫を荒らすのよ。8体お願い!'],
  ...
  b_west: [
    { id:'sq_bud', npc:'npc_miner', npcName:'炭鉱夫バド', type:'delivery', need:{ mats:{ scrap:10 } },
      ...
      done:['恩に着るぜ。これで街の炉も回り続ける。','そういや西の海の向こうに「黄昏の大陸」ってのがある。詩人の隠れ里だ。地図に描いといてやる。'],
  ...
  b_dusk: [
    { id:'sq_sora', npc:'npc_girl', npcName:'吟遊詩人ソラ', type:'hunt', enemy:'bat', count:10,
      ...
      done:['ありがとう。お礼の歌…「南の黒曜の祠に眠る、契約の詩」。','歌の場所、地図に描いておくね。'],
      reward:{ coins:150, hintBase:'b_black', story:'dusk_song' } },
  ],
  b_black: [
    { id:'sq_kage', npc:'npc_sage', npcName:'祠守カゲ', type:'delivery', need:{ mats:{ scrap:12 } },
      requiresStory:'dusk_song', lockedLine:'…契約の詩を知らぬ者に、祠の扉は開かれぬ。',
      intro:['詩を聞いてきたか。ならば祠の結界を直すのを手伝え。','鉄クズ12。結界の芯に使う。'],
      done:['結界は戻った。礼に祠の記録を見せよう。','…西の海の彼方、「骨の野営地」。死者の民が集う場所だ。地図に記した。'],
  ...
  b_bones: [
    { id:'sq_garga', npc:'npc_miner', npcName:'族長ガルガ', type:'hunt', enemy:'skeleton', count:12,
      requiresStory:'black_rite', lockedLine:'よそ者に骨の掟は語らん。祠の結界を知る者なら別だがな。',
      intro:['ここは骨の民の野営地。だが最近、掟を破った骸骨どもが暴れる。','12体、眠らせてやってくれ。'],
      done:['これで祖霊も静かになる。礼だ、北の空を見ろ。','…月だ。「月の修道院」が月影の大陸にある。地図に描いた。'],
  ...
  b_green: [
    { id:'sq_kodama', npc:'npc_miko', npcName:'社守コダマ', type:'hunt', enemy:'boar', count:8,
      ...
      done:['苗木が守られたわ。お礼に社の言い伝えを。','「南東の海に火の島あり。火の民、炉を守りて暮らす」…地図に描くわね。'],
  ...
  b_forge: [
    { id:'sq_hagane', npc:'npc_smith', npcName:'弟子ハガネ', type:'delivery', need:{ mats:{ scrap:20 } },
      ...
      done:['いい火だ…!これで神鉄が打てる。','親方が言ってた。「昔、還る魂の得物を打った。あいつは果ての城へ向かった」…あんたの先達だろ?','親方からの伝言だ。「腕を磨いて、また来い」。'],
  ...
  b_moon: [
    { id:'sq_luna', npc:'npc_miko', npcName:'修道女ルナ', type:'hunt', enemy:'shade', count:10,
      ...
      done:['月光が戻りました…祈りの中で視えたのです。','南の大陸の「墓標の祭壇」に、大きな悲しみが集っている、と。','…それと、これは修道院からの忠告です。書庫の写本には、私たちが「禁じ手」と呼ぶ編み方が混ざっています。','力を編みすぎた魂は、色を変える。長く生きて色を変えた魔物と、同じように。','使うなとは申しません。ただ…呑まれませぬよう。'],
  ...
  b_grave: [
    { id:'sq_tomu', npc:'npc_sage', npcName:'墓守トム', type:'hunt', enemy:'shade', count:8,
      ...
      done:['墓が静かになった…礼に、墓碑に刻まれた言葉を教えよう。','「全ての魂は虚無の門を通る」。西の果ての「隠者の庵」だ。地図に記した。'],
  ...
  b_void: [
    { id:'sq_muu', npc:'npc_sage', npcName:'隠者ムウ', type:'hunt', enemy:'voidwisp', count:8,
      ...
      done:['静寂が戻った…最後に教えよう。北の果ての海に「最果ての城」がある。','この世界の終わりと始まりの場所だ。地図に記す。…良い旅を。'],
  ...
  b_end: [
    { id:'sq_ou', npc:'npc_sage', npcName:'城主オウ', type:'hunt', enemy:'hornedimp', count:10,
      ...
      done:['見事だ。…では約束通り、余の話をしよう。','余の名はオウ。かつて――お前と同じ「死に戻り」であった。','幾百の生を重ね、広場に祭壇を築き、写本を残し、この果てまで辿り着いた。','だが終焉の刻の、その先へは…行けなんだ。だから余はここで、次の魂を待っておった。','砦の老兵が見た旅人も、遺跡の装置を調整した者も、鍛冶神に剣を打たせた者も…全て余だ。','余が越えられなかった終焉の刻を、超えてみせよ。その先で、また会おう。'],
...
DATA.QUESTS = {
  ...
  b_north: { npc:'npc_elder', npcName:'老兵ガルド', type:'hunt', enemy:'skeleton', count:4,
    intro:['…おお、生きた人間か。ワシはこの砦の最後の守り兵じゃ。','夜な夜な骸骨どもが湧いて、砦を奪われてしもうた。','奴らを4体、討ち払ってくれんか。この旗はまだ死んでおらん!'],
    done:['見事じゃ…!砦の狼煙を上げるぞ。','…お前さん、「死に戻り」の魂じゃな。ワシら年寄りには分かる。','命を落としても魂は広場に還り、そこで研いだ力だけが次の生へ持ち越される――そういう質の魂じゃ。','昔もう一人だけ、同じ魂を見たことがある。魂の広場の祭壇を築いた御仁じゃ。','その御仁は「果ての城を目指す」と言い残して、消えた。…お前さんは二人目じゃよ。','お前さんの魂の広場と、この砦が繋がった。いつでも戻ってこい。'] },
  b_east: { npc:'npc_scholar', npcName:'考古学者リナ', type:'hunt', enemy:'goblin', count:4,
    intro:['きゃっ!?…な、なんだ人間か。私はこの遺跡を調べてる研究者。','ゴブリンたちが遺跡のワープ装置を勝手にいじって困ってるの。','4体追い払って!装置が壊れちゃう前に!'],
    done:['助かった〜!…ほら、装置が目を覚ました。','これで魂の広場から直接来られるわよ。研究の成果、期待してて。'] },
  b_south: { npc:'npc_miko', npcName:'泉の巫女スズ', type:'survive', enemy:'slime', time:18,
    intro:['旅の方…この泉は癒しの力を持つのですが、穢れに狙われています。','今から浄化の祈りを捧げます。18秒間、私を守ってください。'],
  ...
  b_white: { npc:'npc_sailor', npcName:'灯台守ハク', type:'hunt', enemy:'crab', count:4,
    intro:['この灯台、何百年も海を照らしてきたんだがな…','アイアンクラブどもが土台を齧りやがる。','4匹叩き落としてくれ。灯りを絶やすわけにはいかん。'],
  ...
  b_mist:  { npc:'npc_sage', npcName:'霧の番人', type:'survive', enemy:'bat', time:21,
    intro:['霧は全てを隠す…宝も、危険も。','観測所を直したい。21秒間、霧の獣から守ってくれ。'],
  ...
  b_ember: { npc:'npc_smith', npcName:'火の子エン', type:'hunt', enemy:'orc', count:4,
    intro:['この島の火は、あたしのおばあちゃんの形見なんだ。','でもオークたちが火を消そうとしてる!','4体やっつけて!お願い!'],
    done:['やったー!火が守られた!あんた、かっこいいね!'] },
  b_frost: { npc:'npc_miko', npcName:'氷の隠者フユ', type:'survive', enemy:'wisp', time:21,
    intro:['…寒いでしょう。ここは時が凍る島。','これから氷の下の花に祈りを込めます。','21秒…氷の精霊たちから、私を守ってくださいな。'],
  ...
  b_moon:  { npc:'npc_sage', npcName:'月の使者ツクヨ', type:'hunt', enemy:'knight', count:4,
    intro:['月影に、闇の騎士どもが巣食っている。','奴らは月の光を喰らう。4体、斬ってくれ。','報酬は…月の社の鍵だ。'],
    done:['月光が戻った…社はお前に開かれた。'] },
  b_storm: { npc:'npc_scholar', npcName:'嵐の観測士ライ', type:'survive', enemy:'wisp', time:25,
    intro:['来たか!ちょうどいい、今から雷雲の芯を観測する!','機材を守ってくれ!25秒だ!死ぬなよ!'],
  ...
  b_grave: { npc:'npc_sage', npcName:'墓守グレイ', type:'hunt', enemy:'necro', count:3,
    ...
    done:['刻が満ちるたび、荒野はリーパーの潮に呑まれる。呑まれた亡骸は、結界を持つこの村に運ばれてくる。','ここはそのための村…潮の世界の、弔いの受け皿さ。','死者たちが感謝している…この祭壇はお前の味方だ。'] },
  // --- 第3環 ---
  b_sun:  { npc:'npc_miko', npcName:'太陽の神官サナ', type:'hunt', enemy:'lizard', count:5,
    intro:['ようこそ、灼けつく神殿へ。','神殿を狙うリザードマンを5体討つこと。それが入信の儀式です。','太陽はすべてを見ています。ごまかしはききませんよ。'],
  ...
  b_end:  { npc:'npc_elder', npcName:'最果ての賢者', type:'survive', enemy:'reaper', time:25,
    intro:['ついに…ここまで来る者が現れたか。','この碑は世界の終わりを見届けるためのもの。','最後の試練だ。25秒、終焉の使者から生き延びよ。'],
    done:['…見届けた。30分――それがこの世界が一つの周回を保てる限界。','刻が満ちれば、世界の縁からリーパーの潮が押し寄せ、結界なき地の全てを刈り取っていく。','人里が結界の村にしか残っておらんのは、そのせいじゃ。','…かつて一人、お前と同じ目をした者がこの碑を越え、城へ入った。戻っては来なんだ。','その先に何があったかは、城の主に聞くがいい。お前こそ、終焉に抗う者。全てを解き放とう。'] },
};
...
DATA.QUESTS2 = {
  ...
  b_east: { npcName:'考古学者リナ', offer:'遺跡の最深部を調査したいの。護衛、お願いできない?',
    ...
    done:['解析完了!…すごいわ、これ身体能力を強化する術式よ。あなたにも使えるはず。','いい?素材は魔物の力の結晶。それを編んで身に宿すのが「スキル」。周回の中でしか編めなくて、死ねばほどける。','でも「編み方」の記憶だけは魂に残る。各地の書庫の写本は、その編み方を研ぎ澄ませるためのものよ。','…それとね、この装置、誰かが先に調整した跡があった。あなたと同じ「還る魂」の波形で。','あなたには先人がいるのよ。この写本の何冊かも、その人が残したものかもしれない。','最深部の装置も動き出したわ。(この基地のパワーアップ施設が使えるようになった!)'],
  ...
  b_south: { npcName:'泉の巫女スズ', offer:'月に一度の大浄化の儀の時期です。また守っていただけますか?',
    ...
    done:['…完璧な浄化です。泉が喜んでいます。','ご存知ですか?広場や各地の施設は、死んでも消えない「魂の記憶」に力を刻むのです。','祭壇は肉体を、研究所は知を、宿舎は絆を。そしてこの泉のような土地の施設は、その土地の力を分け与えます。','これは泉の恵み。お持ちください。(この基地のパワーアップ施設が使えるようになった!)'],
...
{
  const FACQ = {
    b_dragon:['lizard',6,'竜骨の祭具がリザードマンに奪われた。あれがなければ狩りの加護が使えん。','祭具が戻った…竜の力が集落に流れ出す。'],
    b_dusk:['bat',7,'里の歌碑がコウモリの巣にされてしまったの。','歌碑が響きを取り戻したわ。詩の力が里に満ちていく。'],
    b_star:['wisp',7,'祭壇の星水晶がウィスプに吸われている。','星水晶が輝きを取り戻した。祭壇が星の力を注いでくれる。'],
    b_green:['boar',6,'社の御神木の根をイノシシが荒らすの。','御神木が安らいだ…森の恵みが社に巡り始める。'],
    b_white:['crab',6,'灯台の基部にアイアンクラブが張り付いて光が歪む。','光が真っ直ぐ伸びた。灯りの力が街を照らす。'],
    b_black:['shade',6,'祠の契約石にシェイドが取り憑いた。','契約石が静まった…黒曜の力が祠に戻る。'],
    ...
    b_forge:['golem',5,'暴走した古いゴーレムが大炉を占拠している。','大炉が戻った!神鉄の火がお前の力になる。'],
    b_moon:['shade',7,'月光の聖句がシェイドに喰われかけている。','聖句が守られた…月の祈りが修道院に降りる。'],
    ...
    b_void:['voidwisp',6,'庵の静寂がヴォイドウィスプに乱されている。','静寂が戻った…虚無の理が力となる。'],
...
DATA.NPC_TIPS = [
  ...
  '長く生きた魔物は土地の力を吸って色を変える。姿は同じでも中身は別格…だが共鳴すれば、その力ごと仲間になるぞ。',
  '倒した魔物が仲間になるのは「魂の共鳴」。魂が澄んだ相手ほど、お前と響き合いやすい。',
  '村の施設が調子を悪くしていたら、村人に話を聞いてみることだ。大抵、困りごとと繋がっているものさ。',
  '死に戻りを「災いの前触れ」と呼ぶ村もある。気を悪くするな、恐れは知らぬことから来るだけさ。',
  '荒野に人里が無いのは「終焉の潮」のせいだ。結界を持つ村しか残らなかった。ゲートの光がその結界よ。',
  '共鳴した魔物は村の結界を素通りできる。結界が弾くのは「敵意」だけだからな。',
  '狩人の掟「金は挑め、紅は退け、紫は語るな」。色違いに出会ったら思い出せ。',
];

DATA.STATIONS = {
  altar: { name:'強化の祭壇',   sprite:'st_altar', desc:'先代の死に戻りが築いた祭壇。魂に刻まれた戦いの記憶を研ぎ直す(基礎能力)' },
  lab:   { name:'素材研究所',   sprite:'st_lab',   desc:'魔物の素材に宿る力を解き明かす(素材と経済)' },
  camp:  { name:'仲間の宿舎',   sprite:'st_camp',  desc:'共鳴した魂たちが暮らす場所(仲間の強化)' },
  lib:   { name:'スキル書庫',   sprite:'st_lib',   desc:'先人の残した写本の書庫。心得と秘術の編み方を伝える(スキル)' },
};
...
DATA.FAC_STATE = {
  b_north: { tag:'扉が錆びついている', look:['武具庫の扉は錆びつき、固く閉ざされている。','隙間から見える武具は、どれも埃をかぶったままだ…'] },
  b_east:  { tag:'沈黙している',       look:['遺跡の装置は沈黙し、紋様に光はない。','中心の水晶が、力なく濁っている…'] },
  b_south: { tag:'濁っている',         look:['泉の水は淀み、癒しの気配は感じられない。','水面に映る自分の顔さえ、ぼやけて見える…'] },
  b_west:  { tag:'火が入っていない',   look:['大きな炉だが、火の気がまるでない。','灰は冷え切って、鉄の匂いだけが残っている…'] },
  b_dragon:{ tag:'祭具がない',         look:['竜骨の祭壇…だが、在るべき祭具が見当たらない。','骨の台座だけが、ぽつんと残されている…'] },
  b_dusk:  { tag:'静まり返っている',   look:['里の歌碑は汚れ、刻まれた詩が読めなくなっている。','歌声の代わりに、コウモリの羽音だけが響いている…'] },
  b_star:  { tag:'光を失っている',     look:['祭壇の星水晶は曇り、瞬きひとつしない。','頭上の星々だけが、悲しげに瞬いている…'] },
  b_green: { tag:'弱っている',         look:['御神木の根元は無残に掘り返され、葉が力なく垂れている。','木肌に触れても、恵みの気配は返ってこない…'] },
  b_white: { tag:'光が歪んでいる',     look:['灯台の光がゆらゆらと歪み、まともに沖を照らせていない。','基部から、何かが金属を齧る音がする…'] },
  b_black: { tag:'靄に覆われている',   look:['祠の契約石が、黒い靄にまとわりつかれている。','近づくと、ひやりとした悪意が肌を撫でた…'] },
  b_mist:  { tag:'曇っている',         look:['観測所のレンズは白く曇り、何も映さない。','拭っても拭っても、霧が内側から滲んでくる…'] },
  b_bones: { tag:'荒らされている',     look:['祖霊の祭場は骨が散乱し、めちゃくちゃに荒らされている。','これでは祖霊も安らげまい…'] },
  b_ember: { tag:'火が濁っている',     look:['御神火の炎がどす黒く濁り、嫌な煙を上げている。','これでは火の民の力も借りられそうにない…'] },
  b_frost: { tag:'汚れている',         look:['氷の祭壇がぬめった粘液に覆われている。','澄んでいたはずの氷が、これでは台無しだ…'] },
  b_forge: { tag:'占拠されている',     look:['大炉の前に、巨大なゴーレムが仁王立ちしている。','とても近づける状態ではない…'] },
  b_moon:  { tag:'蝕まれている',       look:['月光の聖句が黒い影に蝕まれ、文字が欠けていく。','祈りの言葉が、途切れ途切れにしか読めない…'] },
  b_storm: { tag:'鐘が鳴らない',       look:['鐘楼の鐘に光の渦が巣食い、綱を引いても鳴らない。','バチバチと、雷の精の唸る音だけがする…'] },
  b_grave: { tag:'ざわついている',     look:['安置所の中から、包帯を引きずる音がする。','死者が安らかに眠れていない…'] },
  b_sun:   { tag:'巣に覆われている',   look:['日輪の間は虫の巣で覆われ、黄金の輝きがくすんでいる。','カサカサと、無数の羽音がする…'] },
  b_void:  { tag:'乱れている',         look:['庵の静寂が乱れ、空間がわずかに軋んでいる。','これでは「無」の理に触れることはできない…'] },
  b_end:   { tag:'穢れている',         look:['玉座の間は瘴気に満ち、禍々しい気配が渦巻いている。','デーモンの哄笑が、どこからか聞こえる…'] },
};
