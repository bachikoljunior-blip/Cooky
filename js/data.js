...
DATA.QUESTS2 = {
  b_north: { npcName:'老兵ガルド', offer:'実はな…砦の周りにウルフの群れが居着いてしもうた。狩ってくれんか?',
    ...
    done:['助かった!これで安心して眠れるわい。','礼にワシの戦術を授けよう。仲間を率いる「誓い」の技じゃ。','(新スキル「老兵の誓い」が素材で取得できるようになった!)','砦の武具庫も開けておいたぞ。(この基地のパワーアップ施設が目を覚ました!)'],
  ...
  b_east: { npcName:'考古学者リナ', offer:'遺跡の最深部を調査したいの。護衛、お願いできない?',
    ...
    done:['解析完了!…すごいわ、これ身体能力を強化する術式よ。あなたにも使えるはず。','この術式、素材の編み方に応用できるはずよ。','最深部の装置も起動したわ。(この基地のパワーアップ施設が目を覚ました!)'],
  ...
  b_south: { npcName:'泉の巫女スズ', offer:'月に一度の大浄化の儀の時期です。また守っていただけますか?',
    ...
    done:['…完璧な浄化です。泉が喜んでいます。','これは泉の恵み。お持ちください。','清められた泉は力を分けてくれます。(この基地のパワーアップ施設が目を覚ました!)'],
  ...
  b_west: { npcName:'鍛冶師ドバン', offer:'デカい仕事が入ってな。材料を都合してくれりゃ分け前をやるぜ。',
    ...
    done:['っしゃあ!間に合った!ほらよ、分け前だ。','(報酬を受け取った!)','ついでにお前さん用の炉も火を入れといた。(この基地のパワーアップ施設が目を覚ました!)'],
...
DATA.NPC_TIPS = [
  ...
  '倒した魔物が仲間になるのは「魂の共鳴」だ。詳しくは魂の広場の石碑を読め。',
  'ゲートを開くのは簡単だが、施設を目覚めさせるにはもう一働き要るぞ。',
];
...
// ---- 世界の記憶: システムの背景設定(記録の石碑で読める) ----
DATA.LORE = [
  { t:'死に戻りについて', b:'この世界で命を落とした者の魂は「魂の広場」に還る。広場は生と死の狭間にあり、そこで研いだ力だけが次の生へ持ち越される。' },
  { t:'仲間 ― 魂の共鳴', b:'魔物を倒した瞬間、その魂が澄んでいれば、お前の魂と共鳴して仲間になる。彼らは体を借り直しただけで、中身は同じ一つの魂だ。だから同じ種類なら敵も仲間も同じ強さを持つ。' },
  { t:'スキル ― 心得と秘術', b:'素材は魔物の力の結晶。それを編んで身に宿すのがスキルだ。周回の中でしか編めず、死ねばほどける。だが書庫の写本と各地の施設は、編み方そのものを研ぎ澄ませてくれる。' },
  { t:'パワーアップ ― 祭壇の記憶', b:'魂の広場と各地の施設は、死んでも消えない「魂の記憶」に力を刻む。祭壇は肉体を、研究所は知を、宿舎は絆を。基地の施設は土地の力(竜、星、火、月…)を分け与える。' },
  { t:'色違いの魔物', b:'長く生きた魔物は土地の力を吸い、金、紅、紫、青白と色を変える。姿かたちは同じでも中身は別格。だが共鳴すれば、その力ごと仲間になる。' },
  { t:'終焉の刻', b:'30分。それがこの世界が一つの周回を保てる限界だという。刻が満ちると世界の縁からリーパーが押し寄せ、全てを刈り取っていく…最果ての城の主だけが、その先を知っている。' },
];
